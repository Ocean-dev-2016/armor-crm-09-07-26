...
if ($rarPageCheck && mysqli_num_rows($rarPageCheck) > 0) {
	db_sync_append_page_urls($conn, 671, array(
		...
		'remark_wise_consultant_print.php',
	));
	...
	$now = date('Y-m-d H:i:s');
	$urls = 'remark_wise_report.php,remark_wise_report_get_ajax.php,remark_wise_report_excel.php,remark_wise_high_rate_print.php,remark_wise_consultant_print.php';
	db_sync_run_query($conn, "INSERT INTO page_table (id, page_title, page_slug, page_count, page_urls, isActive, isDelete, adate, created_date)
...
db_sync_register_api_if_missing($conn, 269, 'download_cp_customer_order_pdf', 'CP Customer Order PDF Download', $cpAppApiBase . '&s=269&channel_partner_id=&order_id=');
db_sync_register_api_if_missing($conn, 270, 'update_cp_customer_order_item', 'CP Edit Order Item (qty/rate/discount)', $cpAppApiBase . '&s=270&channel_partner_id=&order_id=&item_id=&qty=&rate=&discount=');
foreach (array(241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270) as $cpAppApiId) {
	$slugMap = array(
		...
		269 => 'download_cp_customer_order_pdf',
		270 => 'update_cp_customer_order_item',
	);
	$urlMap = array(
		...
		269 => $cpAppApiBase . '&s=269&channel_partner_id=&order_id=',
		270 => $cpAppApiBase . '&s=270&channel_partner_id=&order_id=&item_id=&qty=&rate=&discount=',
	);
