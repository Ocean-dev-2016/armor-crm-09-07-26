	          ...
	          <div class="col-lg-12" style="margin: 10px 0!important;">
		          <div class="row">
		       	         ...
		       	         <div class="col-md-1 col-xs-1 col-sm-1">
								<?php
									echo $db->getAddButton("master_route");
								?>		
                         </div>
...
var data_url_sm = "master_route_get_ajax.php";
...
function searchByName(){
	...
	df2=$("#End_quick_stock_adjustment_filter_input").val();
...
function clearSearchByName(){
	...
	$("#End_quick_stock_adjustment_filter_input").val("");
	// displayRecords_sm(500,1);
	callAjax();
...
function del_conf(id){
	...
	if(r){
		window.location.href='master_route_crud.php?mode=delete&id='+id;
	}
}
...
function genSalesExecutiveExcel(){
	    ...
	    var df2=$("#End_quick_stock_adjustment_filter_input").val();
    ...
    function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_route_ajax.php?searchName='+searchName+ "&sales_id=" + sales_id + "&df1=" + df1 + "&df2=" + df2 ,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
