                           ...
                           <div class="col-md-7 col-xs-7 col-sm-7 pull-right">
                             <div class="form-inline" role="form">
                                    <form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
                                          ...
                                          <input type="text" style="width: 450px!important" placeholder="Search By Name / Tax Category:  " class="form-control input-large" name="searchName" id="searchName" value="" />
...
// var category_id="";
var searchName="";
var data_url = "hsncode_get_ajax.php";
...
function getTopCat(tcid){
		...
		$("#results").load(data_url+"?show=" + numRecords + "&searchName=" + searchName + "&top_category_id=" + top_category_id,{"page":page}, function(){ //get content from PHP page
...
function displayRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&searchName=" + searchName + "&status=" + status + "&top_category_id=" + top_category_id,function(){
		loadDataTable();
...
function del_conf(id){
	...
	if(r){
		window.location.href='hsncode_crud.php?mode=delete&id='+id;
	}
}
...
function genSalesExecutiveExcel(){
     ...
     function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_hsncode_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
