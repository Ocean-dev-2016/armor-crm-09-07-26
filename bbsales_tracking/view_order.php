	...
	<tbody class="<?= $cl; ?>">
			...
			<td colspan="5" class="no-border-bottom no-border-top">
				<strong>Details<br/></strong>
					...
					<table class="no-border-top no-border-bottom no-border-right no-border-left" style="width: 100% !important;">
						...
						<tr>
							<td class="no-border-right no-border-bottom no-border-left">PO Date : </td>
		...
		if($items1)
		{
			...
			foreach($ITEMS as $item)
			{
				...
				<tr>
					...
					{
						?>
						<td colspan="2" class="text-center carrtoon_qty ">XXX</td>
						<?php
					} 
					else
					{
					...
					{
						?>
						<td colspan="1" class="text-center">XXX</td>
						<?php
					} 
					else
					{
					...
					{
						?>
						<td colspan="3" class="text-center rate">XXX</td>
						<?php
					} 
					else
					{
	    ...
	    if($cart_detail_d['cash_discount']!="" && $cart_detail_d['cash_discount']!=0 && $cart_detail_d['cash_discount_amount']!="" && $cart_detail_d['cash_discount_amount']!=0 && $cart_detail_d['additional_discount']!="" && $cart_detail_d['additional_discount']!=0 && $cart_detail_d['additional_discount_amount']!="" && $cart_detail_d['additional_discount_amount']!=0)
			...
			<td colspan="9" class="no-border-bottom" rowspan="<?= $rowspan; ?>" style="vertical-align: top;">	
				...
				<div class="row">
					<div class="col-md-12" style="min-height: 145px!important">
				...
				<!-- <span style="color: red;">Contact Sales Person : <?=$Distri_data_a['cname']?> &nbsp; <?=$Distri_data_a['phone']?></span> -->
			...
			{
				?>
				<td colspan="4" class="text-right font-13"><strong>XXX</strong></td>
				<?php
			} 
			else
			{
