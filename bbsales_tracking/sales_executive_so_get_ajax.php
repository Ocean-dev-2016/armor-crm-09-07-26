...
$ctable_where .= " isDelete=0 AND type='sales_officer'";
...
{
	$executive_id=array();
	$ctable_area = "class_id=".$_REQUEST['class_name']." AND area_id = '".$_REQUEST['area']."' AND executive_type='sales_officer' AND isDelete=0";
...
<form action="" name="frm" id="frm" method="post">
	<table id="datatable_so" class="table table-striped table-bordered table-hover">
        <thead>
            <tr>
                <th>No.</th>
                <th>Name</th>
