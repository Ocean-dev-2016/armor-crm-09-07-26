...
function displayItemClassRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&searchName=" + searchName + "&country_id=" + country_id + "&city_id=" + city_id + "&class_id=" + class_id,function(){
		loadDataTable();
	...
	$("#results").on( "click", ".paging_simple_numbers a", function (e){
		...
		$("#results").load(data_url+"?show=" + numRecords + "&searchName=" + searchName + "&country_id=" + country_id + "&city_id=" + city_id + "&class_id=" + class_id,{"page":page}, function(){ //get content from PHP page
...
function genSalesExecutiveExcel(){
 ...
 function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_area_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
