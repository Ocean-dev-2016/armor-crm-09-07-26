...
$ctable 	= "executive";
$ctable1 	= "Chain Wise Customer Report";
$main_page 	= $ctable;
$page 		= "manage_".$ctable;
$page_title = "Chain Wise Customer Report ";
			...
			<div class="row">
					...
					<div class="form-group">
						<label>Search by Customer Type</label><br/>
						  <select class="form-control status"  name="customer_type" id="customer_type" onchange="getcustomer(this.value)">
								...
								<?php 
								$order_type_r=$db->rp_getData('customer_type',"*","isDelete=0 AND id IN(1,2)","id ASC",0);
				...
				<div class="col-md-2 col-xs-2 col-sm-2" style="margin-top:10px">
         		...
         		<div class="col-md-2 col-xs-2 col-sm-2" style="margin-top:10px">
						...
						<label>Search by State</label><br/>
                          <select class="form-control status" multiple="multiple" name="class_id" id="class_id">
                                  <option value=""> Select State</option>
									...
									?>
									<option value="<?php echo $id_d['id']; ?>">
									<?php echo $id_d['name']; ?></option>
										<?php
											}
										}
										?>
                    ...
                    <div class="col-md-2  col-xs-2  col-sm-2" style="margin-top:10px">
					   <div class="form-group">
						 <label>Search by Route</label><br/>
							<select class="form-control  status" multiple="multiple" name="route" id="route">
								<option value="">Select City</option>
							</select>
                        </div>      
                    </div>
			  ...
			  <div class="col-md-7 col-xs-7 col-sm-7 pull-right">
                                <div class="form-inline" role="form">
                                    <form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
                                          ...
                                          <input type="text" style="width: 300px!important" placeholder="Search By Super StockList" class="form-control input-large" name="searchName" id="searchName" value="" />
...
var data_url = "chain_wise_customer_report_get_ajax.php";
...
function displayRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&searchName=" + searchName + "&sales_executive_id=" + sales_executive_id + "&type=" + type + "&flag=" + flag + "&class_id=" + class_id + "&area=" + area + "&route=" + route + "&customer_type=" + customer_type + "&df=" + df1+"&customer_id=" + customer_id ,function(){
		loadDataTable();
	...
	$("#results").on( "click", ".paging_simple_numbers a", function (e){
		...
		$("#results").load(data_url+"?show=" + numRecords + "&searchName=" + searchName + "&type=" + type + "&flag=" + flag + "&class_id=" + class_id + "&area=" + area + "&route=" + route + "&customer_type=" + customer_type + "&df=" + df1 +"&customer_id=" + customer_id ,{"page":page}, function(){ //get content from PHP page
...
<script type="text/javascript">
	function genOrderPrint()
	{
		...
		{
     	var myWindow = window.open('chain_wise_customer_report_print.php?searchName='+searchName+ "&type=" + type + "&class_id=" + class_id + "&area=" + area + "&route=" + route + "&df=" + df1  + "&customer_type=" + customer_type  + "&type=" + type + "&sales_executive_id=" + sales_executive_id + "&customer_id=" + customer_id,'','width=700,height=800');
     	myWindow.print();
