                           ...
                           <div class="col-md-7 col-xs-7 col-sm-7 pull-right">
                             <div class="form-inline" role="form">
                                    <form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
                                          ...
                                          <input type="text" style="width: 450px!important" placeholder="Search By Department Name:  :  " class="form-control input-large" name="searchName" id="searchName" value="" />
...
function genSalesExecutiveExcel(){
 ...
 function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_department_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
