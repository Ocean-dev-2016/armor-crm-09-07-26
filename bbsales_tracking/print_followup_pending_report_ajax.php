<?php
// $page_id=440;$page_slug='page_category';
/*
 * @author Ravi Patel
 */
include("connect.php");
...
if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!="")
{
    ...
    {
        $ctable_where.="visitor_id IN ('-1') AND ";
    }
}
...
{
    $ctable_where .=" refrence_media_id=".$_REQUEST['reference_media_id'];
}
...
<table id="datatable_1" class="table table-striped table-bordered table-hover table">
        <thead>
            <tr>
                <th colspan="12" class="center"><h2>Followup Pending Report <?= date("d-m-Y h:i a");?> Printed By : <?=$_SESSION[SITE_SESS.'SESS_NAME'];?></h2></th>
            </tr>
            <tr>
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    {
                        echo $db->rp_getValue("executive","cname","id='".$ctable_d['visitor_id']."'",0);
                    }
