    ...
    <table>
    	<tr class="font-size">			
			<td colspan="4" class="" rowspan="11" style="vertical-align: top;">	 
				<?php
					$subtotal1 = $db->rp_getValue("sales_return_item","SUM(pro_qty*unitprice)","isDelete=0 AND invoice_id='".$invoice_id."' AND dispatch_item_type=1",0);
...
<table style="page-break-after: always!important;">
	...
	<tbody class="<?= $cl; ?> page" style="border:1px solid #000!important">
		...
		$totalRecord = $db->rp_getTotalRecord("sales_return_item","invoice_id='".$invoice_id."' AND dispatch_item_type=1");

		$items1=$db->rp_getData("sales_return_item","*","invoice_id='".$invoice_id."' AND dispatch_item_type=1");
