<?php
$page_id=631;$page_slug='visit_report_page';
...
var area="";
var class_id="";
var data_url = "lost_sales_report_get_ajax.php";
...
<script type="text/javascript">
	function genReport(){
		var searchName     = $("#searchName").val();
      	...
      	$.ajax({
	        method: "POST",
	        url: "lost_sales_genReport_ajax.php",
	        data:{
...
<script type="text/javascript">
	function genReportPrint(){
		var searchName     = $("#searchName").val();
      	var sales_executive = $("#sales_executive").val();
      	searchName     = encodeURIComponent(searchName.trim());
     	var myWindow = window.open('print_lost_sales_ajax.php?searchName='+searchName,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
