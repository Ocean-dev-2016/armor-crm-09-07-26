...
$data = rtrim($data,"|");
$data1 = rtrim($data1,"|"); //require_once("include_js.php")
?>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?libraries=places,geometry&key=AIzaSyADYWIGFSnn3DHlJblK0hntz5KQiwbD0hk">
    </script>
<script>
...
// var eg4 = '22.267196,70.721512|22.279218,70.762942|22.295511,70.786047|' +
//     '22.282148,70.798604|22.264920,70.784304|22.285496,70.728581';
...
function closeAllInfoWindows(infoWindows) {
  ...
  <div class="floating hidden" id="toggle" style="margin-top: 56px;" hidden>-</div>

    <div id="panel" class="hidden" style="margin-top: 56px;" hidden>
      <div class="block">
        ...
        <div id="button-div" class="col-md-12">
         <!--  <button id="eg1" class="button raised blue">EXAMPLE 1</button>
          ...
          <div class="col-md-6">
                  <button id="distance" class="button raised blue" hidden>Toggle Distances</button>
          </div>
        </div>
      </div>
      <form id="controls">
        <div class="block" >
          <div>
            ...
            <textarea hidden id="coords" class="u-full-width coords-large" type="text" placeholder="-35.123,150.332 | 80.654,22.439" ></textarea>
          ...
          <div>
            ...
            <!-- <input for="interpolate" id="interpolate" type="checkbox"/> -->
          </div>
        </div>
        <div>
          <div class="block">
