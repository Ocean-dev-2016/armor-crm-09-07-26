...
$page_id=530;$page_slug='page_product_report_view';
...
$fileName = "PRODUCT_REPORT-".$cid;

if(!is_dir($fileName)){

	mkdir(PRODUCT_REPORT_FILES.$fileName);

}

$pdf_file_path	= PRODUCT_REPORT_FILES.$fileName."/".$fileName.'.pdf';
...
echo $pdf_file_path;
/*$xl_file_path	= PRODUCT_REPORT_FILES.$fileName."/".$fileName.'.xls';
