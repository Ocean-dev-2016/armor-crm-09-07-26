<?php
$page_id=642;$page_slug='page_industry_type';
$ctable 	= "industry_type";
$ctable1 	= "Industry Type";
$main_page 	= $ctable;
$page 		= "manage_".$ctable;
// $page_title = $ctable1;
$page_title = 'Industry Type';
			...
			<div class="row">
                            ...
                            <div class="slimScrollDiv" style="position: relative;  width: auto; height: auto;">
								...
								<div class="row">
                                 	 <div class="col-md-5 col-xs-5 col-sm-5">
									 	<?php
										echo $db->getAddButton("industry_type");
									      ?>	
				...
				<div class="portlet light">
						...
						<div class="table-toolbar">
							...
							<!-- 	<div class="col-md-6">
									<?php
										echo $db->getAddButton("top_category_master");
									?>	
								</div>								 -->
							</div>
						</div>
...
var status="";
var searchName="";
var data_url = "industry_type_get_ajax.php";
...
function del_conf(id){
	...
	if(r){
		window.location.href='industry_type_crud.php?mode=delete&id='+id;
	}
}
...
function genSalesExecutiveExcel(){
     ...
     function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_industry_type_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city ,'','width=700,height=800');
     	// myWindow.print();
     	setTimeout(function () 
		{
			myWindow.print();
