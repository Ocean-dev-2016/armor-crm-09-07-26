...
<div class="row">
	<div class="col-sm-12">
		<table id="datatable_1" class="table table-striped table-bordered table-hover">
			<tbody>
				<tr>
					<th colspan="2" style="text-align: center;"><?php echo date('d-m-Y h:i A',strtotime($ctable_d['date_time']))." | <b style='color:red;font-size:18px;'>".$ctable_d['inout_status']."</b> | "."Address : " .$ctable_d['app_address'];  ?></th>
				</tr>
				<tr>
					<td>
