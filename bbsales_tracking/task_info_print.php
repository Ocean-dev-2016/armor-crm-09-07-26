...
<?php
        ...
        ?>
			...
			<tr>
			<th>Person Name</th>
			<td class="left"><?php echo $ctable_d['cname'];  ?></td>
			<th>Company Type</th>
			<td class="left"><?php echo  $db->rp_getValue("company_type","name","id='".$ctable_d['company_type']."'",0); ?></td>
			</tr>
			
			<tr>
			<th>Phone</th>
			<td class="left"><?php echo  $ctable_d['phone']; ?></td>									
			<th>Email</th>
			<td class="left"> <?php echo  $ctable_d['email'];  ?></td>
			</tr>
			
			<tr>
			<th>CST Number</th>
			<td class="left"><?php echo  $ctable_d['cst'];  ?></td>
			<th>PAN Number</th>
			<td class="left"><?php echo  $ctable_d['pan']; ?></td>										
			</tr>
			
			<tr>
			<th>GST Number</th>
			<td class="left"><?php echo  $ctable_d['gst'];; ?></td>
			<th>VAT Number</th>
			<td class="left"><?php echo  $ctable_d['vat']; ?></td>
			</tr>
			
			<tr>
			<th>Address</th>
			<td class="left"><?php echo  $ctable_d['address']; ?></td>
			<th>Pin Code</th>
			<td class="left"><?php echo  $ctable_d['zip']; ?></td>
			</tr>
			
			<tr>
			<th>Country</th>
			<td class="left"><?php echo  $ctable_d['country'];//$db->rp_getValue("country","name","id='".$ctable_d['country']."'",0); ?></td>
			<th>State</th>
			<td class="left"><?php echo  $ctable_d['state'];//$db->rp_getValue("state","name","id='".$ctable_d['state']."'",0); ?></td>
			</tr>
			
			<tr>
			<th>City</th>
			<td class="left"><?php echo  $ctable_d['city'];//$db->rp_getValue("city","name","id='".$ctable_d['city']."'",0); ?></td>
			<th>Discount</th>
			<td class="left"><?php echo  $ctable_d['discount']; ?></td>
			</tr>
			...
			<tr>
			<td class="center"><?php echo $ctable_d1['cname']; ?></td></a>
			<td class="center"><?php echo $ctable_d1['type_of_executive']; ?></td>
			<td class="center"><?php echo $ctable_d1['phone']; ?></td>
			<td class="center"><?php echo $ctable_d1['email']; ?></td>
			<td class="center"><?php echo $db->rp_getValue("state","name","id=".$ctable_d1['state'].""); ?></td>
			<td class="center"><?php echo $db->rp_getValue("city","name","id=".$ctable_d1['city'].""); ?></td>
			</tr>
...
?>
			...
			$ctable_r1=$db->rp_getData("executive","*",$where,"",1);
			if(mysqli_num_rows($ctable_r1)>0){
