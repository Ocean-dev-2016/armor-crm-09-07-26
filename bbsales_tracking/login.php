...
$scheck_where = " ip='".$last_ip."' AND attempts>500 AND status='1' ";
...
<!-- BEGIN LOGO -->
<div class="logo"> <a href="<?php echo SITEURL; ?>"> <img src="assets/admin/layout/img/logo-big.png" alt=""/> </a> </div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<form class="login-form" action="password.php" method="post" onSubmit="return check_form();">
		...
		<div class="form-group">
			...
			<div class="input-icon"> <i class="fa fa-envelope-o"></i>
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Phone" name="username" id="username" />
			</div>
		</div>
		<div class="form-group">
