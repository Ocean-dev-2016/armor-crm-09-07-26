...
$page       = "manage_" . $ctable;
$page_title = $ctable1;
$page_hierarchy = array(array("link" => "", "title" => "Sub Master"), array("link" => $ctable . "_manage.php", "title" => $page_title));
include("connect.php");
?>
<!DOCTYPE html>
...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <script type="text/javascript">
            ...
            function displayRecords(numRecords) {
                ...
                $("#results").html("");
                $("#results").load(data_url + "?show=" + numRecords + "&searchName=" + searchName + "&transport_id=" + transport_id, function() {
                    loadDataTable();
                ...
                $("#results").on("click", ".paging_simple_numbers a", function(e) {
                    ...
                    $("#results").load(data_url + "?show=" + numRecords + "&searchName=" + searchName + "&transport_id=" + transport_id, {
                        "page": page
 ...
 function genSalesExecutivePrint() {
        ...
        var myWindow = window.open('print_transport_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
        myWindow.print();
  //        setTimeout(function () 
        // {
        //  myWindow.print();
