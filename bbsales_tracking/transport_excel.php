...
$file_name  = TRANSPORT_MASTER_EXPORT_EXCEL;
$Where = "";
...
$ctable1_r = $db->rp_getData("transport_master","*",$Where,"id DESC",0);

/*for log*/
$flag = "Web";
$module_name = "Transport Master";
...
$objPHPExcel->getActiveSheet()->setCellValue($column1.$rowCount, "  Transport By");
...
{  
  ...
  for($j=0; $j<3;$j++)  
  {
    ...
    {
      $value = $db->rp_getValue("transport_by","name","id='".$row['transport_by_id']."'");
