...
if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!=""){
		...
		$ctable_where .= " (
							cusomer_name LIKE '%".$_REQUEST['searchName']."%' 
						) AND ";
...
$date=date("Y-m-d");
$ctable_where .=" AND DATE(dispatch_date)='".$date."' ";
        ...
        if($ctable_r){
         ...
         ?>
              <tr>
                ...
                <td>
                	<?php echo stripslashes($ctable_d['dispatch_billing_name']); ?><br/>
                	<?php echo stripslashes($ctable_d['dispatch_billing_address']); ?><br/>
                	<?php echo stripslashes($ctable_d['dispatch_billing_city']); ?> <?php echo stripslashes($ctable_d['dispatch_billing_pincode']); ?><br/>
                	
                	
                </td>
                <td><?php echo stripslashes($dispatch_date); ?></td>
				<td><?php echo $status[$ctable_d['status']]; ?></td>
