...
$page_hierarchy=array(array("link"=>"","title"=>"Master"),array("link"=>"expence_category_manage.php","title"=>"Manage ".$ctable1),array("link"=>$ctable1."_crud.php","title"=>"Add/Edit ".$ctable1));
include("connect.php");
require_once("../include/class.expence_category.php");
$objWeight= new Expence();
$name			= "";
$code			= "";
if(isset($_REQUEST['submit'])){
	...
	if(isset($_REQUEST['mode']) && $_REQUEST['mode']=="add"){
		...
		$reply=$objWeight->InsertWeight($detail,$_FILES);
		if($reply['ack']==1)
		{
	...
	else if(isset($_REQUEST['mode']) && $_REQUEST['mode']=="edit")
	{
		...
		$reply=$objWeight->UpdateWeight($detail,$_FILES);
		if($reply['ack']==1){
			$db->addSuccessMessage($reply['ack_msg']);
					...
					<div class="portlet box blue">
						<div class="portlet-body form">
							...
							<div class="row">
								...
								<div class="form-group">
									<input data-image="<?php echo ($image_path!="" && file_exists(EXPENCE_CATEGORY_A.$image_path))?EXPENCE_CATEGORY_A.$image_path:"";?>" type="file" name="image_path" id="image_path" data-old-image-dom="old_image_path" data-old-image-path="<?php echo $image_path ?>" value="" >
								</div>
								</div>
								</div>
							</div>
