...
$file_name  = SUBCATEGORY_MASTER_EXPORT_EXCEL;
$Where = "";
...
$Where .= " 1=1 AND isDelete='0' AND id!='0'";
...
{
 $Where .= " AND tcid = '".$_REQUEST['top_category_id']."' ";
}

$ctable1_r = $db->rp_getData("category_master","id,name,tcid",$Where,"id DESC",0);
...
$objPHPExcel->getActiveSheet()->setCellValue($column2.$rowCount, "Category");
// $objPHPExcel->getActiveSheet()->setCellValue($column2.$rowCount, "Tax Category");
