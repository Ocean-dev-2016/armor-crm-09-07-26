							...
							<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: auto;">
                                ...
                                <div class="col-md-4  col-xs-6  col-sm-6" style="margin-top:10px">
										...
										<label>Search by City: </label><br/>
                                            <select class="form-control input-large status" name="class_id" id="class_id" onChange="getArea(this.value);" autofocus >
...
var data_url = "customer_<?php echo $ctable ?>_reports_get_ajax.php";
...
function displayRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&searchName=" + searchName + "&ToDate=" + ToDate + "&FromDate=" + FromDate + "&sales_executive_id=" + sales_executive_id + "&flag=" + flag + "&class_id=" + class_id ,function(){
		loadDataTable();
	...
	$("#results").on( "click", ".paging_simple_numbers a", function (e){
		...
		$("#results").load(data_url+"?show=" + numRecords + "&searchName=" + searchName + "&flag=" + flag + "&class_id=" + class_id,{"page":page}, function(){ //get content from PHP page
