...
$file_name  = DEPARTMENT_MASTER_EXPORT_EXCEL;
$Where = "";
...
$ctable1_r = $db->rp_getData("department","id,name,code",$Where,"id DESC",0);
...
$objPHPExcel->getActiveSheet()->setCellValue($column1.$rowCount, " Department Name");
