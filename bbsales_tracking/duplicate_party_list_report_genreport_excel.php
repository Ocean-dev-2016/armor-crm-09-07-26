...
// $d.=$string;
$url=ADMINSITEURL."duplicate_party_excel_ajax.php?searchName=".$searchName."&type=".$type."&show=".$show."&state=".$state."&city=".$city."&df1=".$df1;
...
$fileName = "DUPLICATE-PARTYLIST-REPORT-".date("d-m-Y");
