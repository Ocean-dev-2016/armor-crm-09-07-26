...
$flag = "Web";
$module_name = "Tax";
$log_description = $module_name." Print By ".$_SESSION[SITE_SESS.'SESS_NAME']." ON ".date("Y-m-d H:i:s");
$last_id = "";
$ctable = "tax";
  ...
  <thead>
    <tr>
      <th colspan="12" class="center">
        <h2>Tax Report <?= date("d-m-Y h:i a");?> Printed By : <?=$_SESSION[SITE_SESS.'SESS_NAME'];?></h2>
      </th>
    </tr>
    <tr>
      <th width="10%">Sr No.</th>
      <th width="70%">Tax Name</th>
      <th width="20%">Tax Value</th>
    </tr>
  </thead>
 <tbody>
  <?php
  ...
  ?>
    <tr>
      ...
      <td><?php echo stripslashes($ctable_d['value']); ?></td>
    </tr>
  <?php
    }
  }
