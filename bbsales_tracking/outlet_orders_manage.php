<?php
$page_id=526;$page_slug='page_quotation';
$ctable 	= "orders";
$ctable1 	= "Orders";
$main_page 	= $ctable;
$page 		= "manage_".$ctable;
$page_title = "Manage Outlets Orders";
include("connect.php");
...
function displayRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?order_type=" + order_type + "&show=" + numRecords + "&searchName=" + searchName + "&ToDate=" + ToDate + "&FromDate=" + FromDate ,function(){
		loadDataTable();
	...
	$("#results").on( "click", ".paging_simple_numbers a", function (e){
		...
		$("#results").load(data_url+"?order_type=" + order_type + "&show=" + numRecords + "&searchName=" + searchName,{"page":page}, function(){ //get content from PHP page
