...
if($_SESSION[SITE_SESS.'_ADMIN_TYPE']!=0)
{
    ...
    {
        $ctable_where .= " AND status!=-1 AND (user_id='".$_SESSION[SITE_SESS.'REFERANCE_ID']."' OR created_by='".$loginid."')";
    }
    else
    {
        ...
        {              
            ...
            if(!empty($SALEID1))
            {
                ...
                $ctable_where .= " AND status!=-1 AND (user_id IN (".$SALEID1.','.$_SESSION[SITE_SESS.'REFERANCE_ID'].") OR created_by='".$loginid."')";   
                
            }
            else
            {
                $ctable_where .= " AND status!=-1 AND (user_id IN (".$_SESSION[SITE_SESS.'REFERANCE_ID'].") OR created_by='".$loginid."')";        
            }
        }
        else
        {
...
<table id="datatable_1" class="table table-striped table-bordered table-hover1 table">
        <thead class="fix-th">
            ...
            <tr>
                ...
                <th class="fix-th1">Sales Officer Name</th>
