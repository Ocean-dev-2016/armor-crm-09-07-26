...
$file_name  ="Expense Category Report".date('d_m_Y')."_".strtotime("now").".xlsx";
$Where = "";
...
$ctable1_r = $db->rp_getData("expence_category","id,name",$ctable_where,"id DESC",0);
...
// $objPHPExcel->getActiveSheet()->setCellValue($column2.$rowCount, "Department Code");
