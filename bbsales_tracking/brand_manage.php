...
<body class="page-md">
                       ...
                       <div class="portlet-body">
                            <div class="slimScrollDiv" style="position: relative;  width: auto; height: auto;">
                                <div class="row">
                                    ...
                                    <?php
                                        echo $db->getAddButton("brand_master");
                                    ?>      
    ...
    <script type="text/javascript">
        var status = "";
        var searchName = "";
        var data_url = "brand_get_ajax.php";
 ...
 function genSalesExecutivePrint() {
        ...
        var myWindow = window.open('print_brand_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
        myWindow.print();
  //        setTimeout(function () 
        // {
        //  myWindow.print();
        ...
        function del_conf(id) {
            ...
            if (r) {
                window.location.href = 'brand_master_crud.php?mode=delete&id=' + id;
            }
        }
    </script>
</body>
