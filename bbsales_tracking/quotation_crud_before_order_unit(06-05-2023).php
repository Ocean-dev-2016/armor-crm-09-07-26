...
$detail['gstin']	 		 	= isset($_REQUEST['gstin'])?trim($_REQUEST['gstin']):"";
...
$reply = $ObjQuotation->AddQuotation($detail, $item);
if ($reply['ack'] == 1) {
...
$ObjQuotation->PlaceQuotationPanel($detail);
...
$detail['gstin']	  		  = isset($_REQUEST['gstin'])?trim($_REQUEST['gstin']):"";
$detail['dealer_id']		  = $db->clean($_REQUEST['edit_dealer_id']);
$detail['sales_executive_id'] = $db->rp_getValue("quotation_detail", "sales_id", "id='" . $_REQUEST['id'] . "'");
$detail['cid']				  = $db->clean($_REQUEST['edit_dealer_id']);
    ...
    <head>
     ...
     <body class="page-md">
                          ...
                          <div class="portlet box blue">
                                                     ...
                                                     <div class="col-md-4 col-sm-4">
                                                        ...
                                                        <div class="form-group">
                                                           ...
                                                           <select class="form-control customer_id_s"  name="dealer_id1" placeholder="Select Customer" id="dealer_id"  type="text" <?php echo $disabled; ?> onChange="getCategory(this.value)">
                                                              ...
                                                              <?php
                                                                 ...
                                                                 $customers = $db->rp_getData("executive", "*", "isDelete=0 AND type_of_executive='" . $customer_type . "'", "", 0);
                                                                 if ($customers) {
                                                                 	while ($customer = mysqli_fetch_assoc($customers)) {
                                                                 		...
                                                                 		?>
                                                              <option value="<?php echo $customer['id']; ?>" <?php if ($dealer_id == $customer['id']) {echo "selected";} ?> data-phone="<?php echo $customer['phone'] ?>" data-email="<?php echo $customer['email'] ?>" data-address="<?php echo $customer['address'] ?>" data-state="<?php echo $customer['state'] ?>" data-cname="<?= $customer['cname'] ?>"
                                                                 data-company_name="<?= $customer['company_name'] ?>" data-gstin="<?= $customer['gst'] ?>" data-price-list="<?= $price_list_name; ?>" data-cutomer-type="<?= $customer_type1; ?>" data-gst-type="<?= $gst_type ?>"><?php echo $customer['company_name']." - ".$customer['cname']; ?></option>
                                                              <?php
                                                                 }
                                                                 }
                                                                 }
                                                        ...
                                                        <div class="form-group">
                                                           ...
                                                           <div class="row static-info address">
                                                              ...
                                                              <input type="hidden" name="gstin" id="gstin" value="">
                                                           </div>
                                                           <div class="row static-info address">
                                                        ...
                                                        <div class="col-md-6">
                                                           <div class="form-group">
                                                              ...
                                                              <input type="text" readonly="" class="form-control" name="quotation_date" id="quotation_date" value="<?php if($_REQUEST['mode']=='add'){
                                                                 echo date('d-m-Y');}else{ echo $quotation_date;} ?>"/>
                                                              <p class="help-block"></p>
                                                           </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                                    ...
                                                                    <table border="1px" id="datatable_1" class="table table-striped table-bordered table-hover">
                                                                       <thead>
                                                                          ...
                                                                          <tr>
                                                                             ...
                                                                             <th style="padding: 1px!important;"  class="text-center">Box Qty<br/>(NOS)</th>
                                                                             <th style="padding: 1px!important;"  class="text-center">Caret Qty<br/>(in NOS)</th>
                                                                       ...
                                                                       ?>
                                                                             ...
                                                                             <td style='text-align:right;padding: 1px!important;'><input type='hidden' name='outer_size' class='outer_size' value="<?php echo $i['outer_size']; ?>"><input readonly type='text' class='form-control box_qty' style='text-align:right;width:70px;' name='box_qty[]' class='box_qty positive' value="<?php echo $i['box']; ?>"></td>
                            ...
                            <input name='original_price[]' class='original_price form-control' style="text-align:right;width: 80px;" onChange='recalculateRow(this)' type='text' value="<?php echo $i['original_price']; ?>">
                                                                       ...
                                                                       <tfoot>
                                                                          ...
                                                                          <tr>
                                                                             <td colspan="11" align="right">Additional Discount (%)</td>
                                                                             <td style="text-align: right;">
                                               ...
                                               <div class="col-sm-12 col-lg-12 col-xs-12 form-group " style="padding-right:30px;">
                                                  <div class="col-md-5">
                                                     <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="terms_comdition" rows="5" name="terms_comdition" style="resize: vertical;"><?php if($_REQUEST['mode']=="add" && $quotation_id!=""){ echo $db->rp_getValue("quotation_detail","terms_comdition","id='".$quotation_id."'",0); } else if($_REQUEST['mode']=="add" ){ echo $db->custom_html_entity_decode2(DEFAULT_TERMS); } else { echo $terms_comdition;}?></textarea>
                                                        <p class="help-block"></p>
                                                     </div>
                                                  </div>
                                                  <div class="col-md-5">
                                                     <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="faithfully" name="faithfully" style="resize: vertical;"><?php if($_REQUEST['mode']=="add" && $quotation_id!=""){ echo $db->rp_getValue("quotation_detail","faithfully","id='".$quotation_id."'",0); } else if($_REQUEST['mode']=="add") {
               ...
               toastr.error('Please Select Order Unit!!');
                   ...
                   // var duplicate = 0;
                    if (duplicate == 0) {
                       ...
                       "<td style='text-align:right;padding: 1px!important;'><input type='text' name='original_price[]' class='form-control  original_price' style='text-align:right;width: 80px;' value='" + original_price + "' onChange='recalculateRow(this)'  id='original_price'/><input type='hidden' name=is_including[] id=is_including value="+is_including+"><span id='pro_master_price'>"+pro_price_main+"</span></td>" +
        ...
        <script type="text/javascript">
            ...
            {	
               ...
               $(".cart_discount").each(function(index){
                   ...
                   cart_discount.push({"cartdiscount" : thisdiscount,"cat_id" : cat_id});
                });
        ...
        <script type="text/javascript">
           ...
           top_cart_discount.push({"maindiscount" : thismaindiscount,"tc_id" : tc_id});
           });
