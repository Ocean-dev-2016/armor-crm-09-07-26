<?php
$page_id=630;$page_slug='visit_report_page';
$ctable 	= "sales_executive";
$ctable1 	= "Sales Officer Vs Customer Count";
$main_page 	= $ctable;
$page 		= $ctable;
                                	...
                                	<div class="col-md-5 col-xs-5 col-sm-5" style="margin-top:10px">
		                                ...
		                                <div class="form-inline" role="form">
		                                    <form class="form-inline" role="form" onSubmit="return searchByName();">
		                                          ...
		                                          <input type="text" style="width: 250px!important" placeholder="Search By Sales Person Name" class="form-control input-large" name="searchName" id="searchName" value="" />
...
var area="";
var class_id="";
var data_url = "sales_executive_vs_customer_count_report_get_ajax.php";
...
function displayRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&searchName=" + searchName + "&sales_executive=" + sales_executive + "&customer_id=" + customer_id + "&df=" + df1 + "&class_id=" + class_id + "&area=" + area,function(){
		loadDataTable();
...
<script type="text/javascript">
	function genReport(){
		var searchName     = $("#searchName").val();
      	...
      	$.ajax({
	        method: "POST",
	        url: "sales_executive_vs_customer_count_genReport_ajax.php",
	        data:{
...
<script type="text/javascript">
	function genReportPrint(){
		var searchName     = $("#searchName").val();
      	var sales_executive = $("#sales_executive").val();
      	searchName     = encodeURIComponent(searchName.trim());
     	var myWindow = window.open('print_sales_executive_vs_customer_count_report_ajax.php?searchName='+searchName,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
