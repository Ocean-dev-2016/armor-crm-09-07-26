...
{
	$page_title = "Payment Today's Followup";
}
if($_REQUEST['followup_type']=="future")
{
	$page_title = "Payment Future  Followup";
}
if($_REQUEST['followup_type']=="pending")
{
	$page_title = "Payment Pending  Followup";
}
...
$page_hierarchy=array(array("link"=>"","title"=>"HR"),array("link"=>"payment_followuplist_manage.php","title"=>$page_title));
...
var data_url = "payment_followuplist_get_ajax.php";
var searchName="";
var df="";
var df1="";
var df2="";
...
var sales_executive="<?php echo  $_SESSION[SITE_SESS.'_ADMIN_SESS_ID'] ?>";
var followup_type = "";
var isFillter=false;
...
<script type="text/javascript">
	function genSalesExecutivePrint(){
		...
		df2 = 	$("#material_request_filter_input_2").val();
     	var myWindow = window.open('print_payment_followuplist_ajax.php?searchName='+searchName + "&sales_executive=" + sales_executive + "&followup_type=" + followup_type + "&df=" + df+ "&df1=" + df1 +"&df2=" + df2 + "&through=" + through + "&todate=" + todate+ "&fromdate=" + fromdate + "&reference_media_id=" + reference_media_id + "&executive=" + executive,'','width=700,height=800');
     	myWindow.print();
     	setTimeout(function () 
		{
			myWindow.print();
	...
	if(r){
		window.location.href='payment_followuplist_crud.php?mode=delete&id='+id+'&followup_type='+followup_type;
	}
}
    ...
    function genfollowupReport()
    {
    	...
    	$.ajax({
	        method: "POST",
	        url: "payment_followup_reoport_excel.php",
	        data:{
