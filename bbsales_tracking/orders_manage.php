...
$page_hierarchy=array(array("link"=>"","title"=>$ctable1),array("link"=>$ctable."_manage.php","title"=>"Manage Sales Officer ".$ctable1));
include("connect.php");
$FromDate="";
$ToDate="";
?>
...
function displayRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&searchName=" + searchName + "&ToDate=" + ToDate + "&FromDate=" + FromDate + "&sales_executive_id=" + sales_executive_id + "&type=" + type+ "&flag=" + flag,function(){
		loadDataTable();
