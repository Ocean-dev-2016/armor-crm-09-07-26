<?php
$page_id=528;$page_slug='page_product_stock_report';
$ctable 	= "product";
$ctable1 	= "Product";
$main_page 	= "product_mgmt";
$page 		= "manage_".$ctable;
$page_title = "Manage ".$ctable1." Stock Report";
...
var searchName="";
var cid="";
var data_url = "<?php echo $ctable ?>_stock_report_get_ajax.php";
...
function genReportexcel(cid){
	...
	$.ajax({
		type: "POST",
		url: "product_stock_report_genreport.php",
		data: '&rc='+rc,
		beforeSend: function() {
