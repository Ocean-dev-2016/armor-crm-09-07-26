...
<div class="page-container">
                             ...
                             <div class="form-inline" role="form">
                                    <form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
                                        <div class="form-group">
                                          ...
                                          <input type="text" style="width: 450px!important" placeholder="Search By Name / Weight  :  " class="form-control input-large" name="searchName" id="searchName" value="" />
 ...
 function genSalesExecutivePrint() {
        ...
        var myWindow = window.open('print_packing_type_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
        myWindow.print();
  //        setTimeout(function () 
        // {
        //  myWindow.print();
