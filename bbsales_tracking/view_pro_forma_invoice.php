...
$id=$_REQUEST['pro_forma_invoice_id'];
...
$d=file_get_contents(ADMINSITEURL.'formate.php?pro_forma_invoice_id='.$id.'');
//$d.=$string;
...
$mpdf->WriteHTML($d);
$uname	= str_replace(" ","-",stripslashes($db->rp_getValue("proforma_invoice_info","customer_name","id='".$id."'",0)));
