...
$fileName = "CHAIN WISE ORDER".$cid;

if(!is_dir($fileName)){

    mkdir(CHAIN_WISE_CUSTOMER_REPORT.$fileName);

}

$pdf_file_path  = CHAIN_WISE_CUSTOMER_REPORT.$fileName."/".$fileName.'.pdf';
...
$xl_file_path   = CHAIN_WISE_CUSTOMER_REPORT.$fileName."/".$fileName.'.xls';
