	...
	<div class="portlet-title">
        <div class="caption">
            <h2 class="caption-subject bold font-yellow-casablanca uppercase" style="color: #f2784b!important;margin-top: 15px!important;font-size: 16px;font-weight: bold;margin-left: 25px;"><a href="dashboard.php"><i class="fa fa-home" style="font-size:24px;"></i></a><span class="registername"> <?= $page_title ?></span>
            	<span style="float: right;padding-right: 20px;color: black;"><a target="_blank" href="quotation_manage.php"><i class="fa  fa-arrow-circle-o-left" style="font-size:24px;"></i></a></span></h2>
        </div>
    </div>
   	<div class="container">
   		<!-- filter Section -->
                        ...
                        <div class="col-md-6 col-xs-6 col-sm-6">
                            <div class="form-inline" role="form">
                            	<form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
                            		<label>Search By Person Name/Quotation No</label><br/>	
                               		<div class="form-group">
...
<script type="text/javascript" src="js/quotation_pipeline.js"></script>
<script type="text/javascript">
    ...
    var AdminView = 1;
    var searchName = "";
    var url = "quotation_pipeline_ajax_function.php";
