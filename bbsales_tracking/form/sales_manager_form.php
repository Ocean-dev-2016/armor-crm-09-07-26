<form id="inquiry_form_distributor" onSubmit="return check_form()" action="sales_executive_form_function.php" method="post" enctype="multipart/form-data">
	...
	<div class="row">
						...
						<div class="col-md-12">
							...
							<tr> -->
								...
								<td align="center"><input type="checkbox" data-count="3" class="row-check row-check3" name="dealer_order_delete_flag" id="dealer_order_delete_flag" value="1" <?php echo ($dealer_order_delete_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td> -->
									...
									<tr>
										<td>Government Office (Customer Type)</td>
								...
								<td align="center"><input type="checkbox" data-count="5" class="row-check row-check5" name="oem_order_delete_flag" id="oem_order_delete_flag" value="1" <?php echo ($oem_order_delete_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td> -->
									...
									<tr>
										<td>MEP Consultant (Customer Type)</td>
									...
									<tr>
										<td>Brand Approval Visit (Customer Type)</td>
							...
							<tr>
								...
								<td align="center"><input type="checkbox" data-count="10" class="row-check row-check10" name="followup_delete_flag" id="followup_delete_flag" value="1" <?php echo ($followup_delete_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td> -->
									...
									<tr>
										...
										<!-- <td align="center" hidden><input type="checkbox" data-count="31" class="row-check row-check31" name="quotation_approve_flag" id="quotation_approve_flag" value="1" <?php echo ($quotation_approve_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td> -->
									...
									<tr>
										...
										<td align="center">
											<input type="checkbox" data-count="11" class="row-check row-check11" name="create_order_view_flag" id="create_order_view_flag" value="1" <?php echo ($create_order_view_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center">
										</td>
							...
							<tr>
 							...
 							-->
								...
								<td align="center"><input type="checkbox" class="masterCheck masterCheck38" data-count="38" style="width:60px;text-align:center"></td>
									...
									<tr>
										<td>Chain Wise Order History(view,Approve)
										</td>
										...
										<td align="center"><input type="checkbox" class="masterCheck masterCheck42" data-count="42" style="width:60px;text-align:center">
									</tr>
									<tr>
			...
			<div class="portlet grey-cascade box">
				...
				<div class="portlet-body">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<label for="main_city">City <code>*</code></label>
		...
		<div class="col-md-6 pull-right" hidden="">
			<div class="portlet grey-cascade box">
				<div class="portlet-title">
					<div class="caption">
