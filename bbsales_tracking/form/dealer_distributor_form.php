					...
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="super_stockist_id" id="super_stockist_id" onChange="return getClass(this.value)">
							...
							<div class="row">
								...
								<div class="col-md-6" name="client_code" id="client_code">
									<div class="form-group">
														...
														<table class="table table-striped table-bordered table-hover">
															...
															<tbody>
																...
																<tr>
																	...
																	<td align="center"><input type="checkbox" data-count="1" class="row-check row-check1" name="outlets_order_view_flag" id="outlets_order_view_flag" value="1" <?php echo ($outlets_order_view_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>

																	<td align="center"><input type="checkbox" data-count="1" class="row-check row-check1" name="customer_insert_flag" id="customer_insert_flag" value="1" <?php echo ($customer_insert_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
																	<td align="center"><input type="checkbox" data-count="1" class="row-check row-check1" name="customer_update_flag" id="customer_update_flag" value="1" <?php echo ($customer_update_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
																	<td></td>
																</tr>
																<tr>
																	<td>Order</td>

																	<td align="center"><input type="checkbox" data-count="2" class="row-check row-check2" name="order_view_flag" id="order_view_flag" value="1" <?php echo ($order_view_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>

																	<td align="center"><input type="checkbox" data-count="2" class="row-check row-check2" name="order_insert_flag" id="order_insert_flag" value="1" <?php echo ($order_insert_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>

																	<td align="center"><input type="checkbox" data-count="2" class="row-check row-check2" name="order_update_flag" id="order_update_flag" value="1" <?php echo ($order_update_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
																	<td align="center"><input type="checkbox" data-count="2" class="row-check row-check2" name="order_approve_flag" id="order_approve_flag" value="1" <?php echo ($order_approve_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<select class="noSelect2 form-control" name="class_id" id="class_id" onChange="return getArea(this.value)">
										<?php
										if ($mode == "edit") {
										...
										<?php
											...
											/*$class_list_d=$db->rp_getValue("executive","class_id","type_of_executive='super_stockist' AND id=".$super_stockist_id."",0);
								...
								<div class="form-group">
									...
									<select multiple="multiple" class="multi-select" id="area_id" name="area_id[]">
										<?php
										if ($mode == "edit") {
											$area_r = $db->rp_getData("executive_map_area", "DISTINCT area_id", "executive_id='" . $super_stockist_id . "'", "", 0);
											if ($area_r) {
												while ($area_d = mysqli_fetch_array($area_r)) {
													$area = $db->rp_getValue("area", "name", "id='" . $area_d['area_id'] . "' AND isDelete=0 AND isActive=1")
										?>
													<option <?php echo (in_array($area_d['area_id'], $areas)) ? "selected" : ""; ?> value="<?php echo $area_d['area_id']; ?>"><?php echo $area; ?></option>
										<?php
												}
											}
										}
