<form id="inquiry_form_distributor" action="sales_executive_form_function.php" onSubmit="return check_form();" method="post" enctype="multipart/form-data">
	<div class="row">
		<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="sm_id" id="sm_sales_manager" onChange="getSalesExecutive(this,this.value,'#asm_area_sm','sales_manager','area_sales_manager');">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="asm_id" id="asm_area_sm" onChange="getAreaClass(this,'sales_officer_manager')">
											<option value="">Select General Manager</option>
											<?php
											$dd_d = $db->rp_getData('sales_executive', "*", "1=1 AND type='area_sales_manager' AND isDelete=0 AND isActive=1 AND sm_id='" . $sm_id . "'", "", 0);
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group" <?php if ($mode == 'edit') { ?> hidden <?php } ?>>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<textarea type="text" rows="4" class="form-control" name="address" id="address"><?php echo $address; ?></textarea>
										<p class="help-block"></p>
									</div>
								</div>
						...
						<div class="col-md-12">
							<div class="col-md-8">
								<div class="form-group">
									...
									<select class="form-control" name="class_id" id="class_id" onChange="return getArea(this.value,'#asm_area_sm',0)">
										<option value="">Select Class Type</option>
										<?php
										$asm_class_id = $db->rp_getValue("sales_executive", "class_id", "id='" . $asm_id . "'");
										$class_list_d = $db->rp_getData('class', "*", "1=1 AND isDelete=0 AND isActive=1 AND id='" . $asm_class_id . "'", "", 0);
								...
								<div class="form-group">
									...
									<select multiple="multiple" class="multi-select" id="area_id" name="area_id[]">
										<?php
										$area_r = $db->rp_getData("sales_executive_map_area", "*", "class_id='" . $class_id . "' AND sales_executive_id='" . $asm_id . "' AND area_id!=0", "", 0);
										if ($area_r) {
