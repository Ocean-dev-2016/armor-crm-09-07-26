<form id="inquiry_form_distributor" onSubmit="return check_form()" action="sales_executive_form_function.php" method="post" enctype="multipart/form-data">
		...
		<div class="col-md-6 ">
			<div class="portlet grey-cascade box">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-user"></i> &nbsp; Service Executive
					</div>
				</div>
 ...
 -->
									...
									<tr>
										...
										<!-- <td align="center"><input type="checkbox" data-count="11" class="row-check row-check11" name="create_order_approve_flag" id="create_order_approve_flag" value="1" <?php echo ($create_order_approve_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td> -->
