		...
		<div class="col-md-6 col-sm-12">
			<div class="portlet grey-cascade box">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-user"></i> &nbsp; Super Stockist Information
					</div>
				</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<select class="form-control" id="price_list_id" name="price_list_id">
										...
										if ($price_list_r) {
											while ($price_list_d = mysql_fetch_assoc($price_list_r)) {
										?>
									...
									<div class="col-md-12">
										...
										<td></td>
												...
												<tr>
													...
													<td align="center"><input type="checkbox" data-count="1" class="row-check row-check1" name="dealer_order_view_flag" id="dealer_order_view_flag" value="1" <?php echo ($dealer_order_view_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
