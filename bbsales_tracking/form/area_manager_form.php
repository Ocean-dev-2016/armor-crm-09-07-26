<form id="inquiry_form_distributor" onSubmit="return check_form();" action="sales_executive_form_function.php" method="post" enctype="multipart/form-data">
			...
			<div class="col-md-6">
				<div class="portlet grey-cascade box">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-user"></i> &nbsp; Area Sales Manager
						</div>
					</div>
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-6">
										...
										<select name="type_of_company[]" id="type_of_company" class="form-control" multiple>
											<option value="">Select Type Of Company</option>
											<?php
											$company_r = $db->rp_getData("company_master", "*", "isDelete=0", "", 0);

											$type_of_company = explode(',', $type_of_company);

											while ($company_d = mysqli_fetch_assoc($company_r)) {

											?>
												<option <?= (in_array($company_d['id'], $type_of_company)) ? "selected" : "" ?> value="<?= $company_d['id'] ?>">
													<?= $company_d['name'] ?>
												</option>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="sm_id">M.D.</label>
											<select class="form-control" name="sm_id" id="sales_manager" onChange="getSalesExecutive(this,this.value,'#area_sm','sales_manager','area_sales_manager');">
												<option value="">Select Regional Sales Manager</option>
												<?php
												$ss_d = $db->rp_getData('sales_executive', "*", "1=1 AND type='sales_manager' AND isDelete=0", "", 0);
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="asm_id">General Manager</label>
											<select class="form-control" name="asm_id" id="area_sm" onChange="getSalesExecutive(this,this.value,'#sales_officer','area_sales_manager','sales_officer');">
												<option value="">Select Business Development Manager</option>
												<?php
												$dd_d = $db->rp_getData('sales_executive', "*", "1=1 AND type='area_sales_manager' AND isDelete=0 AND sm_id='" . $sm_id . "'", "", 0);
												while ($dd_r = mysqli_fetch_assoc($dd_d)) {
												?>
													<option <?php echo ($asm_id == $dd_r['id']) ? "selected" : ""; ?> value="<?php echo $dd_r['id'] ?>">
														<?php echo $dd_r['username'] . " (" . $dd_r['name'] . ")"; ?>
													</option>
												<?php
												}
												?>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="so_id">Regional Sales Manager</label>
											<!-- <select class="form-control" name="so_id" id="sales_officer" onChange="getAreaClass(this,'area_sales_executive')" > -->

											<select class="form-control" name="so_id" id="sales_officer" onChange="getSalesExecutive(this,this.value,'#sales_executive','sales_officer','sales_executive');">
												<option value="">Select Area Sales Manager</option>
												<?php
												$dd_d = $db->rp_getData('sales_executive', "*", "1=1 AND type='sales_officer' AND isDelete=0 AND isActive=1 AND asm_id='" . $asm_id . "'", "", 0);
												while ($dd_r = mysqli_fetch_assoc($dd_d)) {
												?>
													<option <?php echo ($so_id == $dd_r['id']) ? "selected" : ""; ?> value="<?php echo $dd_r['id'] ?>">
														<?php echo $dd_r['username'] . " (" . $dd_r['name'] . ")"; ?>
													</option>
												<?php
												}
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="so_id">Sales Officer</label>
											<select class="form-control" name="am_id" id="sales_executive">
												<option value="">Select Sales Officer</option>
												<?php

												$am_d = $db->rp_getData('sales_executive', "*", "1=1 AND type='area_manager' AND isDelete=0 AND isActive=1 AND so_id='" . $so_id . "'", "", 0);
												while ($am_r = mysqli_fetch_assoc($am_d)) {
													//echo $am_r['id'];exit();
												?>
													<option <?php echo ($am_id == $am_r['am_id']) ? "selected" : ""; ?> value="<?php echo $am_r['id'] ?>">
														<?php echo $am_r['username'] . " (" . $am_r['name'] . ")"; ?>
													</option>
												<?php
												}
												?>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select name="weekday" id="weekday" class="form-control">
												...
												?>
													<option <?= ($week_key == $weekday) ? "selected" : ""; ?> value="<?= $week_key ?>"><?= $week_value ?></option>
												<?php
												}
												?>
											</select>
						...
						<div class="row">
							<div class="col-md-12">
								<table class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<!-- <th align="center">Approve Flag</th> -->
								...
								<td align="center"><input type="checkbox" class="masterCheck masterCheck3" data-count="3" style="width:60px;text-align:center"></td>
										...
										<tr>
											<td>Government Office (Customer)</td>
								...
								<td align="center"><input type="checkbox" data-count="4" class="row-check row-check4" name="project_order_delete_flag" id="project_order_delete_flag" value="1" <?php echo ($project_order_delete_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td> -->
										...
										<tr>
											<td>Customer</td>
											<td align="center"><input type="checkbox" data-count="100" class="row-check row-check100" name="tradercontractor_view_flag" id="tradercontractor_view_flag" value="1" <?php echo ($tradercontractor_view_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
											<td></td>
											<td></td>
											<td></td>
											<!-- <td></td> -->
											<td align="center"><input type="checkbox" class="masterCheck masterCheck100" data-count="100" style="width:60px;text-align:center"></td>
										</tr>
										<tr>
											<td>MEP Consultant (Customer)</td>
											<td align="center"><input type="checkbox" data-count="101" class="row-check row-check101" name="mep_consultant_view_flag" id="mep_consultant_view_flag" value="1" <?php echo ($mep_consultant_view_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
											<td></td>
											<td></td>
											<td></td>
											<!-- <td></td> -->
											<td align="center"><input type="checkbox" class="masterCheck masterCheck101" data-count="101" style="width:60px;text-align:center"></td>
										</tr>
										<tr>
											<td>Builder (Customer)</td>
											<td align="center"><input type="checkbox" data-count="102" class="row-check row-check102" name="builder_view_flag" id="builder_view_flag" value="1" <?php echo ($builder_view_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
											<td></td>
											<td></td>
											<td></td>
											<!-- <td></td> -->
											<td align="center"><input type="checkbox" class="masterCheck masterCheck102" data-count="102" style="width:60px;text-align:center"></td>
										</tr>
										<tr>
											<td>Brand Approval Visit (Customer)</td>
											<td align="center"><input type="checkbox" data-count="103" class="row-check row-check103" name="brand_approval_visit_view_flag" id="brand_approval_visit_view_flag" value="1" <?php echo ($brand_approval_visit_view_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
											<td></td>
											<td></td>
											<td></td>
											<!-- <td></td> -->
											<td align="center"><input type="checkbox" class="masterCheck masterCheck103" data-count="103" style="width:60px;text-align:center"></td>
										</tr>
										<!-- <tr>
							...
							<tr>
								<td>Corporate Customer (Type)</td>
								<td align="center"><input type="checkbox" data-count="36" class="row-check row-check36" name="corporate_customer_view_flag" id="corporate_customer_view_flag" value="1" <?php echo ($corporate_customer_view_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
								<td></td>
								<td></td>
								<td></td>
								<td align="center"><input type="checkbox" class="masterCheck masterCheck36" data-count="36" style="width:60px;text-align:center"></td>
							</tr> -->
										<tr>
											<td>My Followup</td>
								...
								<td align="center"><input type="checkbox" data-count="10" class="row-check row-check10" name="followup_delete_flag" id="followup_delete_flag" value="1" <?php echo ($followup_delete_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td> -->
										...
										<tr>
											...
											<!-- <td align="center"><input type="checkbox" data-count="31" class="row-check row-check31" name="quotation_approve_flag" id="quotation_approve_flag" value="1" <?php echo ($quotation_approve_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td> -->
 ...
 -->
								...
								<td align="center"><input type="checkbox" class="masterCheck masterCheck38" data-count="38" style="width:60px;text-align:center"></td>
										...
										<tr>
											<td>Travel by Bike</td>

											<td align="center"><input type="checkbox" data-count="39" class="row-check row-check39" name="travel_by_bike_flag" id="travel_by_bike_flag" value="1" <?php echo ($travel_by_bike_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
											<td></td>
											<td></td>
											<td></td>
											<!-- <td></td> -->

											<td align="center"><input type="checkbox" class="masterCheck masterCheck39" data-count="39" style="width:60px;text-align:center"></td>
										</tr>
										<tr>
											<td>Travel by Bus(Train,Aeroplane)</td>

											<td align="center"><input type="checkbox" data-count="40" class="row-check row-check40" name="travel_by_bus_flag" id="travel_by_bus_flag" value="1" <?php echo ($travel_by_bus_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
											<td></td>
											<td></td>
											<td></td>
											<!-- <td></td> -->

											<td align="center"><input type="checkbox" class="masterCheck masterCheck40" data-count="40" style="width:60px;text-align:center"></td>
										</tr>
										<tr>
											<td>Travel by Car</td>

											<td align="center"><input type="checkbox" data-count="41" class="row-check row-check41" name="travel_by_car_flag" id="travel_by_car_flag" value="1" <?php echo ($travel_by_car_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
											<td></td>
											<td></td>
											<td></td>
											<!-- <td></td> -->

											<td align="center"><input type="checkbox" class="masterCheck masterCheck41" data-count="41" style="width:60px;text-align:center"></td>
										</tr>
										<!-- 	<tr>
							<td>Chain Wise Order(View,Approve)</td>

							<td align="center"><input type="checkbox" data-count="42" class="row-check row-check42" name="chain_wise_view_order_history_flag" id="chain_wise_view_order_history_flag" value="1" <?php echo ($chain_wise_view_order_history_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
						
						
							<td align="center"><input type="checkbox" data-count="42" class="row-check row-check42" name="create_order_approve_flag" id="create_order_approve_flag" value="1" <?php echo ($create_order_approve_flag == 1) ? "checked" : ""; ?> style="width:60px;text-align:center"></td>
							<td></td>
							<td></td>

							<td align="center"><input type="checkbox" class="masterCheck masterCheck42" data-count="42" style="width:60px;text-align:center"></td>
							</tr> -->
										<tr>
							...
							<div class="col-md-12">
								<div class="col-md-8">
									<div class="form-group">
										...
										<select class="form-control" name="class_id" id="class_id" onChange="return getArea(this.value,'#sales_officer',0)">
											<option value="">Select Class Type</option>
											<?php
											$so_class_id = $db->rp_getValue("sales_executive", "class_id", "id='" . $so_id . "'");
											$class_list_d = $db->rp_getData('class', "*", "1=1 AND isDelete=0 AND isActive=1 AND id='" . $so_class_id . "'", "", 0);
									...
									<div class="form-group">
										...
										<select multiple="multiple" class="multi-select" id="area_id" name="area_id[]">
											<?php
											$area_r = $db->rp_getData("sales_executive_map_area", "*", "class_id='" . $class_id . "' AND sales_executive_id='" . $so_id . "' AND area_id!=0", "", 0);
											if ($area_r) {
	...
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xs-12 form-group " style="padding-right:30px;">
			...
			<input type="hidden" value="<?php echo $type_of_inquiry; ?>" name="type_of_inquiry" /><input type="hidden" value="<?php echo $_REQUEST['id']; ?>" name="id" />
