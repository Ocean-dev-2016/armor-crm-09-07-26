		...
		<div class="col-md-6 col-sm-12">
			<div class="portlet grey-cascade box">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-user"></i> &nbsp; Government Office Information
					</div>
				</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control pincode-chek" name="zip" id="zip" value="<?php echo $zip; ?>" maxlength="6" size="6">
											<p class="help-block"></p>
										</div>
									</div>
								</div>
											...
											?>
												<?php if ($count == 1) { ?>
													<div class="form-group">
														<div class="col-md-6 phone-m">
															<label>Phone</label>
															<input type="text" class="form-control multiple-phone-number" name="phone[]" id="phone" value="<?php echo $customer_vs_phone_no_d['phone_no']; ?>" maxlength="15" size="15" minLength="10">
														</div>
														<div class="col-md-6 phone-m">
												...
												<?php } else { ?>
													<div class="col-md-12">
														...
														<div class="col-md-6">
															<label>Phone</label>
															<input type="text" class="form-control multiple-phone-number" name="phone[]" id="phone" value="<?php echo $customer_vs_phone_no_d['phone_no']; ?>" maxlength="15" size="10" minLength="10">
														</div>
														<div class="col-md-6">
															<label>Customer Name</label>
															<input type="text" class="form-control" name="customer_name[]" id="customer_name" value="<?php echo $customer_vs_phone_no_d['name']; ?>">
