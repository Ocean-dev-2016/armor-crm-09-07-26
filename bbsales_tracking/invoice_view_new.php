...
<table>
	<tbody class="<?= $cl; ?>">
		...
		<tr>
			<td colspan="6" class="no-border-top no-border-right height-5 text-center"></td>
			<td colspan="4" class="no-border-top no-border-right height-5 text-center"><b>GST - <?= COMPANY_GST ?></b></td>
			<td colspan="6" class="no-border-top height-5 text-center"></td>
		</tr>

		<tr>
			<td colspan="6" class="no-border-bottom  height-5 text-center"></td>
			<td colspan="4" class="no-border-bottom  no-border-left height-5 text-center"><b>PAN - <?= COMPANY_PAN ?></b></td>
		...
		<tr>
			...
			<td colspan="4" class="text-center no-border-right no-border-bottom bg-gray"><b>Tax Invoice</b></td>
		...
		<tr class="vertical-top">
			...
			<td colspan="4" class="no-border-bottom no-border-top border-r-width">
			...
			<td colspan="6" class="no-border-bottom no-border-top ">
				...
				<table class="no-border-top no-border-bottom no-border-right no-border-left" style="width: 45mm!important;margin:0px;">
					<tr>
						<td class="no-border-right no-border-bottom no-border-left no-border-top"><b>Invoice No :</b> <?= $cart_detail_d['invoice_no'] ?></td>
					</tr>
					<tr>
						<td class="no-border-right no-border-bottom no-border-left no-border-top"><b>Invoice Date :</b> <?php if($cart_detail_d['invoice_date']!=""){ echo date('d-m-Y', strtotime($cart_detail_d['invoice_date'])); } else { echo "";}?></td>
					</tr>
					<tr>
...
// echo $gst_amount;
			...
			<td colspan="5" class="text-right font-13"><strong><?php echo CURR.' '.$db->rp_number_format(round($totalprice,2),2); ?></strong></td>
		</tr>

		<tr>
			<td colspan="3" class="text-left font-13"><strong>Cash Discount</strong></td>			
			<td colspan="5" class="text-right font-13"><strong>
				<?php
		...
		if($cart_detail_d['igst_amount']!="0")
		{
			...
			else
			{
				if (strtolower(CLIENT_STATE) == strtolower($Distri_data_a['state'])) 
				{
					...
					<tr>
						<td colspan="3" class="text-left"><strong>C GST</strong></td>			
						<td colspan="5" class="text-right "><strong><?= (CURR. $db->rp_number_format($finalgst/2,2))?></strong> </td>
					</tr>
					<tr>
						<td colspan="3" class="text-left"><strong>S GST</strong></td>			
						<td colspan="5" class="text-right "><strong><?= (CURR. $db->rp_number_format($finalgst/2,2))?></strong></td>
				...
				else
				{
					...
					?>
						<tr>
							<td colspan="3" class="text-left"><strong>IGST</strong></td>		
							<td colspan="5" class="text-right "><strong><?= (CURR. $db->rp_number_format($finalgst,2))?></strong></td>
						</tr>
						<tr>
							<td colspan="3" class="text-left"></td>			
							<td colspan="5" class="text-right "></td>
