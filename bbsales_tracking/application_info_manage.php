                                 ...
                                 <div class="col-md-6 col-xs-6 col-sm-6 pull-right " style="margin-top:10px">
								  ...
								  <form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
								   <div class="form-group">
										...
										<input type="text" class="form-control input-small" name="searchName" id="searchName" value="" placeholder="Version Name" />
									</div>
									 <div class="form-group">
					...
					<div class="portlet light">
						...
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<?php
										echo $db->getAddButton("application_info");
									?>	
								</div>								
							</div>
						</div>
...
var status="";
var searchName="";
var data_url = "application_info_get_ajax.php";
...
function del_conf(id){
	...
	if(r){
		window.location.href='application_info_crud.php?mode=delete&id='+id;
	}
}
</script>
</body>
