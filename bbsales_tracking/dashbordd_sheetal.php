...
include("connect.php");
$main_page = "home";
// echo $db->encrypt_decrypt('encrypt', "6-12-2022");exit;
		...
		<div class="col-md-12 col-sm-12" >
			...
			<div class="row">
				<!-- <div class="col-md-12 col-sm-12 co-xs-12 col-lg-12"> -->
					<?php include("data_tiles_ajax.php"); ?>
				<!-- </div> -->
			</div>
			...
			<!-- <div class="row">
				<div class="col-md-12 col-sm-12 co-xs-12 col-lg-12">
					<?php //include("get_class_area_count.php"); ?>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12 col-sm-12 co-xs-12 col-lg-12">
					<?php //include("get_class_area_count_pending_customer.php"); ?>
				</div>
			</div> -->
		</div>	
	</div>
