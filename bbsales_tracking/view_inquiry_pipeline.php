...
if($_REQUEST['type']=="-1")
{
	$page_title = 'Raw Data Pipeline';
	$back_link  = "no_order_inquiry_grid.php?type=-1";
}
else if($_REQUEST['type']=="0")
{
	$page_title = 'Inquiry Pipeline';
	$back_link  = "no_order_inquiry_grid.php?type=0";
}
else
{
	...
	<div class="portlet-title">
        <div class="caption">
            <h2 class="caption-subject bold font-yellow-casablanca uppercase" style="color: #f2784b!important;margin-top: 15px!important;font-size: 16px;font-weight: bold;margin-left: 25px;"><a href="dashboard.php"><i class="fa fa-home" style="font-size:24px;"></i></a><span class="registername"> <?= $page_title ?></span>
            	<span style="float: right;padding-right: 20px;color: black;"><a target="_blank" href="<?=$back_link ?>"><i class="fa  fa-arrow-circle-o-left" style="font-size:24px;"></i></a></span></h2>
        </div>
    </div>
   	<div class="container">
   		<!-- filter Section -->
							...
							<div class="col-md-3">
	                            <div class="form-group">
	                          	 	<label>Customer Type</label><br/>	
                          	  		<select class="form-control input-small" id="customer_type">
                        ...
                        <div class="col-md-6 col-xs-6 col-sm-6">
                            <div class="form-inline" role="form">
                            	<form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
                            		<label>Search By Person/Company Name/Mobile No/Email</label><br/>	
                               		<div class="form-group">
                               			<input type="text" style="width: 450px!important" placeholder="Search By Person/Company Name/Mobile No/Email :  " class="form-control input-large" name="searchName" id="searchName" value="" />
                               		</div>
                               		<div class="form-group">
			...
			<div class="row">
				<div class="col-sm-12">
					<div id="label_container">
						<div class="task-container" style="overflow-y: scroll;min-height: 500px!important;max-height: 500px!important;"></div>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="js/inquiry_pipeline.js"></script>
<script type="text/javascript">
    ...
    var url = "inquiry_pipeline_ajax_function.php";
