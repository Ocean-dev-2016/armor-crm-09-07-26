							   		...
							   		<div class="col-md-7 col-xs-7 col-sm-7 pull-right">
							   			<form class="form-inline pull-right" role="form" action="#" onSubmit="return searchByName();">
												<div class="form-group">
													<input type="text" name="searchName" id="searchName" value="" style="width: 450px!important" class="form-control input-large" placeholder="Search By Name :  " />
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu dropdown-menu-right pull-right">
															...
															?>
																	<li>
																		<a name="print" onClick="genTaxPrint()" title="Print Report"><i class="fa fa-print"></i>Print</a>
																	</li>
															<?php
																}
...
function genTaxPrint() {
 	var searchName     = $("#searchName").val();
   	 searchName     = encodeURIComponent(searchName.trim());

 	var myWindow = window.open('print_tax_ajax.php?searchName='+searchName ,'','width=700,height=800');
  	// myWindow.print();
  	setTimeout(function () 
	{
		myWindow.print();
