                           ...
                           <div class="col-md-7 col-xs-7 col-sm-7 pull-right">
                             <div class="form-inline" role="form">
                                    <form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
                                          ...
                                          <input type="text" style="width: 450px!important" placeholder="Search By State/City Name  :  " class="form-control input-large" name="searchName" id="searchName" value="" />
...
function displayItemClassRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&searchName=" + searchName + "&country_id=" + country_id + "&class_id=" + class_id+ "&district_id=" + district_id,function(){
		loadDataTable();
	...
	$("#results").on( "click", ".paging_simple_numbers a", function (e){
		...
		$("#results").load(data_url+"?show=" + numRecords + "&searchName=" + searchName + "&country_id=" + country_id + "&class_id=" + class_id+ "&district_id=" + district_id,{"page":page}, function(){ //get content from PHP page
...
function genSalesExecutiveExcel(){
 ...
 function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_city_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
