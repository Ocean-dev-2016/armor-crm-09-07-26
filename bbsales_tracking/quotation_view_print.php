...
<table>
	<tbody>
		<tr>
			...
			<td colspan="8" class="no-border-left no-border-right " style="font-size: 20px; "><strong>CHANAKYA ENGINEERING PRODUCTS</strong></td>
		...
		<tr>
			...
			<td colspan="4" class="text-right "><strong><?php echo $db->rp_number_format(round($final_price,2)); ?></strong></td>
		</tr>
		<tr>
