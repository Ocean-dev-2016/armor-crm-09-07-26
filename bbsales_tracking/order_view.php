...
<table>
	<tbody>
		...
		<tr>
			<td colspan="3" class="text-left"><strong>Debit Memo</strong></td>
			<td colspan="9" class="text-center no-border-left"><strong>Proforma Invoice</strong></td>
			<td colspan="4" class="text-right no-border-left"><strong>ORIGINAL FOR RECIPIENT</strong></td>
		</tr>
		<tr>
			<td colspan="10" style="width: 45%!important">
				...
				{*/
					...
					<strong><?= $cart_detail_d['company_name']." - ".$cart_detail_d['customer_name'] ?></strong><br>
					<?php echo $Distri_data_a['address']."  <br/>".$Distri_data_a['city']." - ".$Distri_data_a['zip']." , ".$Distri_data_a['state']." , ".$Distri_data_a['country'] ?></span><br/>
					<span>GST No. : <?php echo $Distri_data_a['gst']; ?></span><br/>
					<span>Mobile  : <?php echo $Distri_data_a['phone']; ?></span><br>
					<span>Mail : <?=$Distri_data_a['email']?></span><br/>
			...
			<td colspan="6" >
				...
				Invoice No. : <strong><?=$cart_detail_d['order_no']?></strong><p1 style="float: right;">Date : <?=$order_date;?></p1><br>
	...
	<tbody>
		...
		else
		{
			...
			<td colspan="10" class="" rowspan="">	
				<!-- <strong><b>Terms & Condition</b></strong><br> -->
