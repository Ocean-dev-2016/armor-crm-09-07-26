	...
	<table id="datatable_1" class="table table-striped table-bordered table-hover">
        ...
        ?>
            <tr>
                ...
                <td><?php echo stripslashes($ctable_d['start_time']); ?></td>
                <td><?php echo stripslashes($ctable_d['end_time']); ?></td>
			    <!-- <td>
        ...
        <?php
			...
			?>
			<tr>
			<td colspan="5"><p style="text-align:center;">No data available in table</p></td>
			</tr>
			<?php
		}
        ?>
