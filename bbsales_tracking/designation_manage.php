...
<body class="page-md">
	...
	<div class="page-container">
    	...
    	var searchName     = $("#searchName").val();
      	...
      	$.ajax({
	        method: "POST",
	        url: "designation_report_excel.php",
	        data:{
     ...
     function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_designation_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city ,'','width=700,height=800');
     	// myWindow.print();
     	setTimeout(function () 
		{
			myWindow.print();
