...
$page_hierarchy=array(array("link"=>"","title"=>"HR"),array("link"=>"future_followup_manage.php","title"=>$page_title));
include("connect.php");
                            ...
                            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: auto;">
									<div class="row filter_list">
										...
										<div class="col-md-3">
									       <div class="form-group">
									        <label>Search By Sales Officer Name</label>	
											    <select class="form-control input-medium" name="sales_executive" id="sales_executive"  onchange="searchBysalesExecutive(this.value);" >
										...
										<div class="col-md-2 col-xs-2 col-sm-2 pull-right" style="margin-top:10px">
											...
											<button type="button" class="btn print" style="background-color: #f0ad4e;color: #fff;" name="print" onClick="genfuturefollowupPrint()" id="print" href="" title="Download XL Report"><i class="fa fa-print"></i>Print</button>
										</div>
                                    ...
                                    <div class="row">
										...
										<div class="col-md-2 col-xs-2 col-sm-2 pull-right" style="margin-top:20px;">
											<form action="#" class="form-inline" onSubmit="return searchByName();">
												<div class="form-group">
...
var data_url = "future_followup_get_ajax.php";
var searchName="";
var df="";
...
function displayRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&ToDate=" + df + "&reference_media_id=" + reference_media_id + "&searchName=" + searchName + "&executive=" + executive + "&sales_executive=" + sales_executive ,function(){
		loadDataTable();
	...
	$("#results").on( "click", ".paging_simple_numbers a", function (e){
		...
		$("#results").load(data_url+"?show=" + numRecords + "&ToDate=" + df + "&reference_media_id=" + reference_media_id + "&searchName=" + searchName + "&executive=" + executive + "&sales_executive=" + sales_executive,{"page":page}, function(){ //get content from PHP page
...
<script type="text/javascript">
	function genfuturefollowupPrint(){
		var searchName     = $("#searchName").val();
      	searchName     = encodeURIComponent(searchName.trim());
      	executive=$("#executive").val();
		sales_executive=$("#sales_executive").val();
     	var myWindow = window.open('print_future_followup_ajax.php?searchName='+searchName+ "&ToDate=" + df + "&executive=" + executive + "&sales_executive=" + sales_executive ,'','width=700,height=800');
     	myWindow.print();
    }
</script>
</body>
