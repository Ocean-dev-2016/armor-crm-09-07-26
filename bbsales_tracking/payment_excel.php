...
$file_name  = "Payment"."_".date("d-m-Y").".xlsx";
...
$ctable1_r = $db->rp_getData("payment","*",$Where,"payment_date DESC",0);
...
$objPHPExcel->getActiveSheet()->setCellValue($column4.$rowCount, "Receipt No.");
$objPHPExcel->getActiveSheet()->setCellValue($column5.$rowCount, "Payment by");
$objPHPExcel->getActiveSheet()->setCellValue($column6.$rowCount, "Payment Date");
$objPHPExcel->getActiveSheet()->setCellValue($column7.$rowCount, "Payment Amount");
