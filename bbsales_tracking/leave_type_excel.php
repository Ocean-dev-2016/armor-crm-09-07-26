...
$file_name  ="Leave Type Report".date('d_m_Y')."_".strtotime("now").".xlsx";
$Where = "";
...
$ctable1_r = $db->rp_getData("leave_type","id,name",$ctable_where,"id DESC",0);
...
$objPHPExcel->getActiveSheet()->setCellValue($column1.$rowCount, "  Leave Type");
