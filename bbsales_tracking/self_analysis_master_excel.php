...
$file_name  = SELT_ANALYSIS_MASTER_EXPORT_EXCEL;
$Where = "";
...
$ctable1_r = $db->rp_getData("self_analysis","*",$Where,"id DESC",0);

/*for log*/
$flag = "Web";
$module_name = "Self Analysis Master";
...
$objPHPExcel->getActiveSheet()->setCellValue($column1.$rowCount, "  Questions");
