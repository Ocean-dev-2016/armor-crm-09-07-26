...
var data_url = "invoice_report_get_ajax.php";
...
function displayRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&searchName=" + searchName + "&sales_executive_id=" + sales_executive_id + "&type=" + type + "&flag=" + flag + "&class_id=" + class_id + "&area=" + area + "&customer_type=" + customer_type + "&df=" + df1 ,function(){
		loadDataTable();
	...
	$("#results").on( "click", ".paging_simple_numbers a", function (e){
		...
		$("#results").load(data_url+"?show=" + numRecords + "&searchName=" + searchName + "&type=" + type + "&flag=" + flag + "&class_id=" + class_id + "&area=" + area + "&customer_type=" + customer_type + "&df=" + df1 ,{"page":page}, function(){ //get content from PHP page
...
function genReportexcel(cid)
{
	...
	$.ajax({
		type: "POST",
		url: "invoice_genreport_excel.php",
		data: '&rc='+rc,
		beforeSend: function() {
			$(".transCover").fadeIn(800);
			$("#loading").modal('show');
...
<script type="text/javascript">
	function genOrderPrint()
	{
		...
		sales_executive_id = $("#sales_executive_id").val();
		// alert(type);
     	var myWindow = window.open('print_invoice_report.php?searchName='+searchName+ "&type=" + type + "&class_id=" + class_id + "&area=" + area + "&df=" + df1  + "&customer_type=" + customer_type  + "&type=" + type + "&sales_executive_id=" + sales_executive_id,'','width=700,height=800');
     	// myWindow.print();
     	setTimeout(function () 
		{
			myWindow.print();
