...
$fileName = "INVOICE-FILE-".$cid;

if(!is_dir($fileName)){

	mkdir(INVOICE_FILES.$fileName);

}

$pdf_file_path	= INVOICE_FILES.$fileName."/".$fileName.'.pdf';
...
$xl_file_path	= INVOICE_FILES.$fileName."/".$fileName.'.xls';
