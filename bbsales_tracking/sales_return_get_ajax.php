...
<form action="" name="frm" id="frm" method="post"> 
	<div style="text-align: -webkit-right;;">
		<table class="table_amount table-striped table-bordered table-hover">
			...
			<tr>
				<td style="text-align: right;padding-right: 10px;"><strong>Total Sales Return </strong></td>
			...
			<tr>
				<td style="text-align: right;padding-right: 10px;"><strong>Approve Sales Return Total Amount </strong></td>
				<td style="padding-right: 10px;" id="total-invoice-value-approve"></td>
			</tr>
			<tr>
				<td style="text-align: right;padding-right: 10px;"><strong>Pending Sales Return Total Amount </strong></td>
				<td style="padding-right: 10px;" id="total-invoice-value-pending"></td>
			</tr>
			<tr>
				<td style="text-align: right;padding-right: 10px;"><strong>Cancel Sales Return Total Amount </strong></td>
				<td style="padding-right: 10px;" id="total-invoice-value-cancel"></td>
			</tr>
			<tr>
				<td style="text-align: right;padding-right: 10px;"><strong>Disapprove Sales Return Total Amount </strong></td>
	...
	<table id="datatable_1" class="table table-striped table-bordered table-hover">
        <thead class="fix-th">
        	...
        	<tr>
	            ...
	            <th>
	            	<select class="form-control input-small" id="type">
	            		<option value="">Select Sales Return Type</option>
	            		<?php
            ...
            <tr>
                ...
                <th class="fix-th1">Original Invoice No. & Date</th>
                <th class="fix-th1">Credit Note No.</th>
                <th class="fix-th1">Credit Note Date</th>
                ...
                <th class="fix-th1">Sales Return Type</th>
                <th class="fix-th1" style="text-align:right;">Sales Return Amount without Gst</th>
                <th class="fix-th1" style="text-align:right;">Sales Return Amount with Gst</th>
        ...
        if($ctable_r)
        {
            ...
            while($ctable_d = mysqli_fetch_array($ctable_r))
            {
	            ...
	            <tr <?= $style ?>>
	            	<td>
						<div class="btn-group">
							...
							<ul role="menu" class="dropdown-menu">
								...
								?>
								<li> 
		                            <a href="sales_return_crud.php?mode=edit&id=<?=$ctable_d['id'];?>" title="Edit"><span class="text-primary"><i class="fa fa-pencil"></i>&nbsp;Edit</span>
		                            </a>
	                        	</li>
								<?php	
								}
								...
								$file_path="sales_return_viewer.php?sales_return_id=".$ctable_d['id']."";
								?>
								<li>
	               ...
	               <!--  <td>
	                ...
	                <td>
	                	<?php 
	                	$invoice_no_r=$db->rp_getData("invoice_new","invoice_no,invoice_date","isDelete=0 AND id IN(".$ctable_d['original_invoice_id'].")");
				$invoice_no=array();
				...
				echo $invoice_no;
	                ...
	                <td>
	                	<?php if($ctable_d['invoice_date']!=""){ echo date('d-m-Y',strtotime($ctable_d['invoice_date'])); }else{ echo "";}?>
	                </td>
	               <!--  <td><?php if($ctable_d['adate']!=""){ echo date('d-m-Y',strtotime($ctable_d['adate'])); }else{ echo "";}?></td> -->
	                ...
	                <?php
    					...
    					$items1=$db->rp_getData("sales_return_item","*","invoice_id='".$ctable_d['id']."' AND dispatch_item_type=1","",0);
        	...
        	$t_invoice = $db->rp_getTotalRecord("sales_return",$ctable_where,0);
        	//$t_invoice_val = $db->rp_getValue("sales_return","SUM(grand_total)",$ctable_where,0); 
        	$t_invoice_val = $db->rp_getValue("sales_return","SUM(grand_total)",$ctable_where,0); 
        	$t_invoice_val_approve = $db->rp_getValue("sales_return","SUM(grand_total)","isDelete=0 AND status=1 AND".$ctable_where,0); 
        	$t_invoice_val_pending = $db->rp_getValue("sales_return","SUM(grand_total)","isDelete=0 AND status=0 AND".$ctable_where,0); 
        	$t_invoice_val_cancel = $db->rp_getValue("sales_return","SUM(grand_total)","isDelete=0 AND status=3 AND".$ctable_where,0); 
        	$t_invoice_val_disapprove = $db->rp_getValue("sales_return","SUM(grand_total)","isDelete=0 AND status=-2 AND".$ctable_where,0); 
        }
        ?>
        </tbody>
    </table>
