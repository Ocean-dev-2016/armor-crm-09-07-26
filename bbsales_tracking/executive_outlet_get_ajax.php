...
$ctable_where .= " isDelete=0 AND type_of_executive='3'";
...
{
	$executive_id=array();
	$ctable_area = "class_id=".$_REQUEST['class_name']." AND area_id = '".$_REQUEST['area']."' AND executive_type='3' AND isDelete=0";
...
<form action="" name="frm" id="frm" method="post">
	<table id="datatable_outlet" class="table table-striped table-bordered table-hover">
        <thead>
        	<tr>
        		<th></th>
        		<th></th>
        		...
        		<th></th>
        		<th>
        			<select class="form-control" name="state" id="state" onChange="filter_state(this.value);" autofocus >
        		...
        		<th>
        			<select class="form-control" name="city" id="city"  autofocus onChange="filter_city(this.value);">
        ...
        ?>
            <tr>
							...
							<ul role="menu" class="dropdown-menu">
								...
								if($rights['update_flag']==1)
								{
									...
									<li>
										...
										{
											?>
											<a href="<?php echo $ctable; ?>_crud.php?mode=isActive&id=<?php echo $ctable_d['id']; ?>&status=1" title="Activate">
												<span class="text-success">
													<i class="fa fa-circle"></i>
													&nbsp;Activate
												</span>
				...
				<td><?php echo $ctable_d['city'];//$db->rp_getValue("city","name","name=".$ctable_d['city'].""); ?></td>
				<td><?php echo $ctable_d['state'];//$db->rp_getValue("state","name","name=".$ctable_d['state'].""); ?></td>
