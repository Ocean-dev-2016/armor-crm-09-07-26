...
$file_name  = HSN_MASTER_EXPORT_EXCEL;
$Where = "";
...
if (isset($_REQUEST['searchName']) && $_REQUEST['searchName'] != "") {
  ...
  if($pro_r1)
  {
    ...
    $Where = " (name like '%" . $_REQUEST['searchName'] . "%') AND isDelete='0'";
  }
  if(!empty($PROIDS1))
  {
...
$ctable1_r = $db->rp_getData("hsncode_master","id,name,tax_id",$Where,"id DESC",0);
