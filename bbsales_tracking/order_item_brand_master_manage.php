<?php
$page_id=665;$page_slug='order_item_brand_master';
$ctable     = "order_item_brand_master";
$ctable1     = "Brand Master ";
$main_page     = "product_mgmt";
$page         = "manage_" . $ctable;
$page_title = $ctable1;
$page_hierarchy = array(array("link" => "", "title" => "Sub_master"), array("link" => $ctable . "_manage.php", "title" => $page_title));
include("connect.php");
?>
<!DOCTYPE html>
...
<body class="page-md">
 ...
 function genSalesExecutivePrint() {
        ...
        var myWindow = window.open('print_purpose_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
        myWindow.print();
  //        setTimeout(function () 
        // {
        //  myWindow.print();
