...
if(isset($_REQUEST['executive_count']) && $_REQUEST['executive_count']!="")
{
	$ctable_where .=" AND executive_counter='".$_REQUEST['executive_count']."'";
}
$customer_details = $db->rp_getData("executive","*",$ctable_where,"",0);
...
<table>
 <tbody>
  <tr>
   ...
   <td colspan="16" class="right" style="border-right:none;"><b><center><h3>executive Information</h3></center></td>
  <!--<td colspan="3" style="border-left:none;"> <b>Date : </b><?php echo date('d-m-Y',strtotime($customer_detail['created_date'])) ?></td>-->
	...
	<tr>
		...
		<td class="center">executive Counter</td>
  ...
  <tr>
		...
		<td class="center"><?php echo $customer_detail['current_address']?>
				<?php
				if($customer_detail['executive_city']!="")
				{
					echo ",".$customer_detail['executive_city'];
				}
				if($customer_detail['executive_state']!="")
				{
					echo ",".$customer_detail['executive_state'];
				}
				if($customer_detail['executive_country']!="")
				{
					echo ",".$customer_detail['executive_country'];
				}
				?>
		</td>
		...
		<td><?php echo $customer_detail['executive_counter']; ?></td>
  </tr>
  <?php 
