...
$Results=$db->rp_getData("customer_inward_stock","*",$Where,"id DESC",0);
?> 
 <style>
.mainDiv, table{
  height: auto;   
    ...
    <thead>
    	...
    	<tr>
            ...
            <td class="header" align="center" colspan="8" >
            	<h2>
            		<b>Customer Manual Stock <?php echo $_REQUEST['planning_date'];?> Printed By : <?=$_SESSION[SITE_SESS.'SESS_NAME'];?></b>
            	</h2>
            </td>
        </tr>
