...
$Results=$db->rp_getData("target","*",$Where,"",0);
?> 
		...
		{												
 		...
 		?>
	  	<tr class="">
			...
			<td><?php echo $R['target_year']; ?></td>
			<td><?php echo $R['target_month']; ?></td>
			<td><?php echo $R['target_amount']; ?></td>
			<td><?php echo $R['target_quantity']; ?></td>
			<td>
