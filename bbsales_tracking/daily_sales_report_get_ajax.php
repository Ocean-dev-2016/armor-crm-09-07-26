            ...
            while($ctable_dP = mysqli_fetch_array($ctable_r11))
            {
              ...
              <tr>
                ...
                <td>
                  ...
                  if($ctable_dP['reference_table']=="sales_executive")
                  {
                    echo $db->rp_getValue("executive","mobile_no1","id='".$ctable_dP['visitor_id']."'");
                  }
                  else if($ctable_dP['reference_table']=="no_order_inquiry")
                  {
            ...
            while($ctable_dF = mysqli_fetch_array($ctable_r9))
            {
              ...
              <tr>
                ...
                <td>
                    ...
                    if($ctable_dF['reference_table']=="sales_executive")
                    {
                      echo $db->rp_getValue("executive","mobile_no1","id='".$ctable_dF['visitor_id']."'");
                    }
                    else if($ctable_dF['reference_table']=="no_order_inquiry")
                    {
            ...
            while($ctable_dL = mysqli_fetch_array($ctable_r10))
            {
              ...
              <tr>
                ...
                <td>
                    ...
                    if($ctable_dL['reference_table']=="sales_executive")
                    {
                      echo $db->rp_getValue("executive","company_name","id='".$ctable_dL['visitor_id']."'");
                    }
                    else if($ctable_dL['reference_table']=="no_order_inquiry")
                    { 
              ...
              <tr>
                ...
                <td>
                  ...
                  if($ctable_d6['reference_table']=="sales_executive")
                  {
                    ...
                    echo "<b>".$db->rp_getValue("executive","company_name","id='".$ctable_d6['visitor_id']."'")."</b><br>".$db->rp_getValue("executive","cname","id='".$ctable_d6['visitor_id']."'");
                  }
                  ...
                  else if($ctable_d6['reference_table']=="no_order_inquiry")
                  {
                    ...
                    echo  "<b>".$db->rp_getValue("no_order_inquiry","company_name","id='".$ctable_d6['reference_id']."'")."</b><br>".$db->rp_getValue("no_order_inquiry","person_name","id='".$ctable_d6['reference_id']."'");
                  }
                  else if($ctable_d6['reference_table']=="customer_inquiry")
                  {
                    $followup_flag="leads_followup";
                    echo "<b>".$db->rp_getValue("customer_inquiry","company_name","id='".$ctable_d6['reference_id']."'")."</b><br>".$db->rp_getValue("no_order_inquiry","person_name","id='".$ctable_d6['reference_id']."'");
                  }
                  else if($ctable_d6['reference_table']=="executive")
                  {
                    $followup_flag="customer_followup";
                    echo "<b>".$db->rp_getValue("executive","company_name","id='".$ctable_d6['reference_id']."'")."</b><br>".$db->rp_getValue("executive","cname","id='".$ctable_d6['reference_id']."'"); 
                  }
                    /*if($ctable_d6['reference_table']=="sales_executive")
                    {
                ...
                <td>
                    ...
                    if($ctable_d6['reference_table']=="sales_executive")
                    {
                      echo $db->rp_getValue("executive","mobile_no1","id='".$ctable_d6['visitor_id']."'");
                    }
                    else if($ctable_d6['reference_table']=="no_order_inquiry")
                    {
                      echo $db->rp_getValue("no_order_inquiry","mobile_number","id='".$ctable_d6['reference_id']."'");
                    }
                    else if($ctable_d6['reference_table']=="quotation_detail")
                    {
                      $cid = $db->rp_getValue("quotation_detail","customer_id","id='".$ctable_d6['reference_id']."'",0);
                      echo $db->rp_getValue("executive","mobile_no1","id='".$cid."'",0);
                    }
                    else if($ctable_d6['reference_table']=="customer_inquiry")
                    {
                      echo $db->rp_getValue("customer_inquiry","mobile_number","id='".$ctable_d6['reference_id']."'");
                    }
                    else if($ctable_d6['reference_table']=="executive")
                    {
                      echo $db->rp_getValue("executive","mobile_no1","id='".$ctable_d6['reference_id']."'");
                    }
                    ?>
                </td>
