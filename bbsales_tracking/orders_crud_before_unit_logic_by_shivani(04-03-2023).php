...
if (!empty($c_type) || $_REQUEST['mode'] == "edit"){
...
<select class="form-control" <?php echo $disabled_customer; ?> id="customer_type" name="customer_type" onchange="getCustomer(this.value)">
...
<option value="2">Box Pack</option>
<option value="3">Caret Pack</option>
...
<input readonly name='bag[]' class='form-control bag' style="text-align:right;width:70px;"  type='text' value="<?php echo $i['bag']; ?>">
</td>
...
<td style="text-align:right;padding: 1px!important;">
<input type='text' style="text-align:right;width:80px;" onChange='recalculateRow(this)' class='qty form-control' name='qty[]' value="<?php echo $i['qty']; ?>" class="positive">
</td>
