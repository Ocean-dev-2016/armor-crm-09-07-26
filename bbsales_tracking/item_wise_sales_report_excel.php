...
$merge_file = array();
$string ="<style>table,th,tr,td{border:1px solid #000; padding:10px;font-size:15px;}a{text-decoration:none;}</style>";
...
$fileName = "Item-Wise-Sales-Report-".strtotime("now").$cid;
