...
<table id="example1" class="table table-bordered table-striped dataTable">
	...
	?>
		<tr>
			...
			<td>
				<?php
				if($ctable_d['image_path']!="" && file_exists(EXPENCE_CATEGORY_A.$ctable_d['image_path'])){
				?>
					<img src="<?php echo EXPENCE_CATEGORY_A.$ctable_d['image_path']; ?>" width="50" />
				<?php
				}else{
