...
<form action="" name="frm" id="frm" method="post">
	<table id="datatable_1" class="table table-striped table-bordered table-hover">
        ...
        if(mysqli_num_rows($ctable_r)>0){
            ...
            $city=$db->rp_getValue("city","name","id='".$ctable_d['city']."'");
			//print_r($ctable_d);
        ?>
            <tr>
				...
				<div class="btn-group">
					...
					<ul role="menu" class="dropdown-menu">
						...
						<li>
							<a href="#myModal" data-id="<?php echo  stripslashes($ctable_d['id']); ?>" data-toggle="modal" title="View Vendor"><span class="text-success"><i class="fa fa-circle"></i>&nbsp; View Vendor</span></a>
