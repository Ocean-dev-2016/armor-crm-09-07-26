<?php
$page_id=578;$page_slug='expense_category_page';
$ctable 	= "expence_category";
$ctable1 	= "Expense Category";
$main_page 	= $ctable;
$page 		= "manage_".$ctable;
$page_title = $ctable1;
...
function genSalesExecutiveExcel(){
    	var searchName     = $("#searchName").val();
      	...
      	$.ajax({
	        method: "POST",
	        url: "expense_category_excel.php",
	        data:{
 ...
 function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_expense_category_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
