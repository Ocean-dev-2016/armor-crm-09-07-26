...
$main_page 	= $ctable;
$page 		= "General Credit Note";
$page_title = "General Credit Note";
$FromDate="";
$ToDate="";
				...
				<div class="portlet light">
					<div class="table-toolbar">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="btn-group">
										<a class="btn sbold blue-ebonyclay" href='general_credit_note_crud.php?mode=add'> Add New
...
function genSalesExecutiveExcel(){
    ...
    function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('general_credit_print_ajax.php?searchName='+searchName+ "&type=" + type + "&ToDate=" + ToDate + "&FromDate=" + FromDate ,'','width=700,height=800');
     	myWindow.print();
    ...
    function printcreditnote(cid) 
    {
			
			var myWindow = window.open('print_general_credit_note.php?id='+cid ,'','width=700,height=800');
     	myWindow.print();
