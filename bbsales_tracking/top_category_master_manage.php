...
var status="";
var searchName="";
var data_url = "top_category_master_get_ajax.php";
...
function CheckDispalyOrder(id)
{
	...
	$.ajax({
		...
		data: 'display_order='+display_order+"&id="+size_id+"&table=top_category_master",
		success: function(result){
...
function del_conf(id){
	...
	if(r){
		window.location.href='top_category_master_crud.php?mode=delete&id='+id;
	}
}
</script>
</body>
