...
$file_name  = "statedata_".date('d_m_Y')."_".strtotime("now").".xlsx";
$Where = "";
...
$ctable1_r = $db->rp_getData("class","id,name,country_id",$Where,"id DESC",0);
...
{  
  ...
  for($j=0; $j<3;$j++)  
  {
    ...
    else if($j==1)
    {
      ...
      $value = $db->rp_getValue("country","name","isDelete=0 AND id='".$row['country_id']."'");
