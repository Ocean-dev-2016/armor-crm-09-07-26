...
$ctable 	= "customer_notes";
$ctable1 	= "Stock Detail";
$main_page 	= $ctable;
	...
	<div class="page-head bg-grey">
		<div class="container">
			<div class="page-title">
				<h1><a href="<?php echo "product_stock_report_manage.php";?>" class="btn primary"><i class="fa fa-arrow-circle-o-left"></i>&nbsp;back</a> &nbsp;<?php echo $page_title; ?></h1>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	{
		var pro_id='<?php echo $_REQUEST['id']?>';
