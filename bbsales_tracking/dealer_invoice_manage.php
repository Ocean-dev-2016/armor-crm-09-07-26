...
$page_hierarchy=array(array("link"=>"","title"=>"Sales & Marketing"),array("link"=>"dealer_invoice_manage.php","title"=>$page_title));
include("connect.php");
$FromDate='';
$ToDate='';
							...
							<div class="slimScrollDiv" style="position: relative;  width: auto; height: auto;">
								<div class="row">
									<div class="col-md-5 col-xs-5 col-sm-5">
                                        <a class="btn sbold blue-ebonyclay" href="invoice_crud_new.php?mode=add"> Add New<i class="fa fa-plus"></i></a>
                                    </div>
	                                    ...
	                                    <div class="form-inline" role="form">
	                                        <form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
	                                            <div class="form-group">
	                                            	<input type="text" style="width: 450px!important" placeholder="Search By   Person Name/Invoice No:  " class="form-control input-large" name="searchName" id="searchName" value="" />
	                                            </div>
...
<script type="text/javascript" src="assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>
	<script type="text/javascript">
		var searchName="";
		var data_url = "invoice_get_ajax_new.php";
		...
		function displayRecords(numRecords) {
			...
			// qid 	= encodeURIComponent(qid.trim());
		...
		function del_conf(id){
			...
			if(r){
				...
				window.location.href='invoice_crud_new.php?mode=delete&id='+id;
		...
		// 	type = $("#type").val();
		// 	sales_id = $("#sales_id").val();
		//  	var myWindow = window.open('print_dealer_order_ajax.php?searchName='+searchName+"&uid=" + uid + "&status=" + status + "&sales_id=" + sales_id + "&type=" + type + "&df=" + df1+ "&qid=" + qid,'','width=700,height=800');
		//  	setTimeout(function () 
		// 	{
		// 		myWindow.print();
	...
	function cancel_invoice(id){
		...
		if(r){
			window.location.href='invoice_crud_new.php?mode=cancel_invoice_flag&id='+id;
		}
	}
