<?php
    ...
    $ctable     = "attendance";
    $ctable1    = "Attendance";
    //$address    = $db->getAddress($_REQUEST['lat'],$_REQUEST['lng']);
    $response = array("ack"=>1,"ack_msg"=>"Sales Tracking Fetched!!");
    $response["result"][] = array("lat"=>$_REQUEST['lat'],"lng"=>$_REQUEST['lng'],"name"=>$_REQUEST['salesexename'],"dates"=>$_REQUEST['date'],"type"=>"Attendance","address"=>$address);
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDklPuT2SCmcmlflaoZ4B0WywYK_em79x4&callback=initMap">
        </script>