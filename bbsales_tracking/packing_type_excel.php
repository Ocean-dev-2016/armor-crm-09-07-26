...
$file_name  = PACKINGTYPE_MASTER_EXPORT_EXCEL;
$Where = "";
...
if (isset($_REQUEST['searchName']) && $_REQUEST['searchName'] != "") {
    $ctable_where .= " (
              name like '%" . $_REQUEST['searchName'] . "%' OR          
                            weight like '%" . $_REQUEST['searchName'] . "%'                   
            ) AND ";
}

$ctable_where .= " isDelete=0";

$ctable1_r = $db->rp_getData("packing_type","id,name,weight",$ctable_where,"id DESC",0);

/*for log*/
$flag = "Web";
$module_name = "Packing Type Master";
...
$objPHPExcel->getActiveSheet()->setCellValue($column1.$rowCount, "  Name");
   $objPHPExcel->getActiveSheet()->setCellValue($column2.$rowCount, " Weight");
