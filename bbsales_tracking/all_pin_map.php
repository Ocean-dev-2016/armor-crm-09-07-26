        ...
        $.each(locations, function(i, v) {
            ...
            google.maps.event.addListener(marker, 'click', (function(marker, i) {
                return function() {
                    ...
                    infowindow.setContent("<h1>" + (i + 1) + ") " + locations[i]['date'] + "</h1><p>Lat:" + locations[i]['lat'] + "<br/> Long:" + locations[i]['lng'] + " <br/>" + locations[i]['type'] + "<p><b>Address</b>:" + locations[i]['address'] + "<br/><h4><b>Name:" + locations[i]['name'] + "<br/><a style='color:" + color + "'>" + "</a></b></h4></p>");
