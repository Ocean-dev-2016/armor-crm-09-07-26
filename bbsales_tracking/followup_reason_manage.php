...
<div class="page-container">
 ...
 function genSalesExecutivePrint() {
        ...
        var myWindow = window.open('print_followup_reason_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
        myWindow.print();
  //        setTimeout(function () 
        // {
        //  myWindow.print();
