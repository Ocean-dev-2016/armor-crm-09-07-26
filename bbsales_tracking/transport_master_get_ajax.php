...
if(isset($_REQUEST['transport_id']) && $_REQUEST['transport_id']!="" && $_REQUEST['transport_id']!=NULL && $_REQUEST['transport_id']!=undefined)
{
 $ctable_where .= "  transport_by_id = '".$_REQUEST['transport_id']."' AND ";
}
            ...
            if ($ctable_r) 
            {
                ...
                while ($ctable_d = mysqli_fetch_array($ctable_r)) 
                {
                    ...
                    <tr>
                        ...
                        <td><?php echo $db->rp_getValue("transport_by","name","id='".$ctable_d['transport_by_id']."'"); ?></td>
