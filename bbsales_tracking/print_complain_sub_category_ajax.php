  ...
  <thead>
    <tr>
      <th colspan="12" class="center">
        <h2>Complain/Request Sub Category Master <?= date("d-m-Y h:i a");?> Printed By : <?=$_SESSION[SITE_SESS.'SESS_NAME'];?></h2>
      </th>
    </tr>
    <tr>
      <th>Sr No.</th>
      <th>Complain/Request Category</th>
      <th>Complain/Request Sub Category</th>
 ...
 <tbody>
  ...
  ?>
    <tr>
     ...
     <td>
        <?php 
          echo $db->rp_getValue("complain_category","name","id='".$ctable_d['complain_category_id']."'",0);
        ?>
      </td>
      <td>
        <?php 
