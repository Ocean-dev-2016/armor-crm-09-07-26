...
$file_name  = "Company Type Mater"."_".date("d-m-Y").".xlsx";
// $file_name  = UNIT_MASTER_EXPORT_EXCEL;
$Where = "";
...
$ctable1_r = $db->rp_getData("company_type","id,name",$Where,"id DESC",0);
...
{  
  ...
  for($j=0; $j<2;$j++)  
  {
    ...
    {
      $value = $db->rp_getValue("tax","name","id='".$row['tax_id']."'"); 
    }
    else if($j==4)
    {
      $value = $row['phone'];
