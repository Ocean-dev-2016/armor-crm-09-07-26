...
<body class="page-md">
 ...
 function genSalesExecutivePrint() {
        ...
        var myWindow = window.open('print_zone_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
        myWindow.print();
  //        setTimeout(function () 
        // {
        //  myWindow.print();
