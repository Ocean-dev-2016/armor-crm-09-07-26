...
$ctable_where .= " isDelete=0 AND state_id='".$_REQUEST['state_id']."' ";
...
<form action="" name="frm" id="frm" method="post">
	<table id="datatable_city" class="table table-striped table-bordered table-hover">
        <thead>
            <tr>
                <th>No.</th>
                <th>City Name</th>
        ...
        ?>
            <tr>
				...
				<td>
                <a class="btn btn-primary btn-sm btnQuickEdit" id="btnQuickEdit<?php echo $ctable_d['id']; ?>" href="javascript:void(0);" title="Quick Edit city" onClick="quickEdit('<?php echo $ctable_d['id']; ?>')"><i class="fa fa-pencil"></i></a>
				<?php
