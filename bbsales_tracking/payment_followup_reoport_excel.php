...
$file_name  = PAYMENT_FOLLOWUP_REPORT_EXPORT_EXCEL;
...
$ctable1_r = $db->rp_getData("payment_followup","id,reference_table,visitor_id,reference_id,user_id,created_date,followup_date,description,through,response_date,response,entry_type,response_entry_flag,response_update_flag",$ctable_where,"id DESC",0);
...
{  
  ...
  for($j=0; $j<13;$j++)  
  {
    ...
    {
      $value = $db->rp_getValue("dealer_distributor_network","name","id='".$row['user_id']."'");
    }
    else if($j==4)
    {
