...
<table id="example1" class="table table-bordered table-striped dataTable">
	...
	?>
		<tr>
				...
				if($rights['update_flag']==1)
				{
					...
					<div class="btn-group">				
						...
						<ul role="menu" class="dropdown-menu">
							<li>
								<a href="category_crud.php?mode=edit&id=<?php echo $ctable_d['id']; ?>" title="Edit">
			...
			<td>
			<?php 
			echo $db->rp_getValue("top_category_master","name","id='".$ctable_d['tcid']."'"); 
			?>
			</td>
			<td>
				<?php
				if($ctable_d['image_path']!="" && file_exists(CATEGORY_A.$ctable_d['image_path'])){
				?>
					<img src="<?php echo CATEGORY_A.$ctable_d['image_path']; ?>" width="50" />
				<?php
				}else{
			...
			<!-- <td>
			<a class="btn btn-info btn-sm" onClick="window.location.href='category_crud.php?mode=edit&id=<?php echo $ctable_d['id']; ?>'" title="Edit"><i class="fa fa-pencil"></i></a>
