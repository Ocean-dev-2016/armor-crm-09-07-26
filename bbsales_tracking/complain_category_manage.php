...
function genSalesExecutiveExcel(){
    	var searchName     = $("#searchName").val();
      	...
      	$.ajax({
	        method: "POST",
	        url: "complain_category_excel.php",
	        data:{
 ...
 function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_complain_category_ajax.php?searchName='+searchName+ "&type=" + type + "&state=" + state + "&city=" + city + "&top_category_id=" + top_category_id ,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
