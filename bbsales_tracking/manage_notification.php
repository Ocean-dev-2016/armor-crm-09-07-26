...
var data_url_today = "ajax_get_today_<?php echo $ctable ?>.php";
var data_url_pending = "ajax_get_pending_<?php echo $ctable ?>.php";
...
function displayRecords(numRecords) {
			...
			var numRecords  = $("#numRecords").val();
			$("#results" ).html("");
			$("#results" ).load( "ajax_get_notification.php?show=" + numRecords + "&searchName=" + searchName); //load initial records
			...
			$("#results").on( "click", ".paging_simple_numbers a", function (e){
				...
				$("#results").load("ajax_get_notification.php?show=" + numRecords + "&searchName=" + searchName,{"page":page}, function(){ //get content from PHP page
					$(".loading-div").hide(); //once done, hide loading element
		...
		function del_conf(id){
			...
			if(r){
				window.location.href='add_<?php echo $ctable; ?>.php?mode=delete&id='+id;
			}
		}
</script>
<script>
