                                	...
                                	<div class="col-md-6 col-xs-6 col-sm-6" style="margin-top:10px">
		                                <div class="form-inline" role="form">
		                                    <form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
		                                          ...
		                                          <input type="text" style="width: 250px!important" placeholder="Search By Industry Type Name" class="form-control input-large" name="searchName" id="searchName" value="" />
...
var area="";
var class_id="";
var data_url = "industry_type_get_ajax_report.php";
...
<script type="text/javascript">
	function genReport(){
		var searchName     = $("#searchName").val();
      	...
      	$.ajax({
	        method: "POST",
	        url: "industry_type_genReport_ajax.php",
	        data:{
...
<script type="text/javascript">
	function genReportPrint(){
		var searchName     = $("#searchName").val();
      	var sales_executive = $("#sales_executive").val();
      	searchName     = encodeURIComponent(searchName.trim());
     	var myWindow = window.open('print_industry_type_reort.php?searchName='+searchName,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
