		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12" id="report_content">
					<div id="wrapper">
						<?php include("customer_orders_view.php");?>
					</div>
...
function genReport(bid){
	...
	$.ajax({
		type: "POST",
		url: "customer_orders_generate.php",
		data: 'order_id='+bid,
		beforeSend: function() {
...
{	
	//var myWindow =  window.open('customer_orders_view.php?order_id='+id+"&p=1",'','width=800,height=800');
	 // myWindow.print();
