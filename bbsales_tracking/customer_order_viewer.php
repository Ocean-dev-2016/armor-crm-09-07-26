		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12" id="report_content">
					<?php include("customer_order_view.php");?>
				</div>
			</div>
		</div>
	</div>
...
function genReport(bid){
	...
	$.ajax({
		type: "POST",
		url: "customer_order_generate.php",
		data: 'request_id='+bid,
		beforeSend: function() {
...
{	
	//var myWindow =  window.open('customer_order_view.php?request_id='+id+"&p=1",'','width=800,height=800');
	//  myWindow.print();
