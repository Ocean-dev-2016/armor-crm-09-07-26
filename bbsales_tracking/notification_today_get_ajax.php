...
if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!=""){
	$ctable_where .= " (
							notification_title like '%".$_REQUEST['searchName']."%'
...
if($_SESSION['SESS_TYPE']!=0)
{
   ...
   $ctable_where .= "isDelete=0 AND referance_type!='expense' AND user_id='".$_SESSION[SITE_SESS.'_ADMIN_SESS_ID']."' AND DATE(adate) = '".$today."' AND notification_type!=1 AND notification_type!=9 ";
}
else{
     //$ctable_where .= "isDelete=0 AND DATE(respective_date) = '".$today."'";
     $ctable_where .= "isDelete=0 AND referance_type!='expense' AND DATE(created_date) = '".$today."'";
   }
    ...
    <div class="row">
		<div class="col-md-6">
			<div class="dataTables_info"> Rows Limit:
				<select id="numRecords1" onChange="changeDisplayRowCount1(this.value);">
