...
$page_id=661;$page_slug='goal_setting_to_goal_achieving';
$ctable 	= "goal_setting_to_goal_achieving";
$ctable1 	= "Goal Setting To Goal Achieving";
$main_page 	= "HR";
								...
								<div class="row filter_list">
                                    ...
                                    <div class="col-md-8 col-xs-8 col-sm-8" style="margin-top:10px;">
								  	...
								  	<div class="col-md-2 col-xs-2 col-sm-2 pull-right" style="margin-top:10px">
								  		...
								  		<button type="button" class="btn btn-sm print pull-right" style="background-color: #f0ad4e;color: #fff;" name="print" onClick="PrintReport()" id="print" href="" title="Download XL Report"><i class="fa fa-print"></i>Print</button>
								  		<?php
											}
					...
					<div class="portlet light">
						...
						<div class="table-toolbar">
							<div class="row">
								...
								<a id="add_questions" href="goal_setting_to_achieving_crud.php?mode=add" class="btn sbold blue-ebonyclay"> Add New
...
var data_url = "goal_setting_to_achieving_get_ajax.php";
...
function del_conf(id){
	...
	if(r){
		...
		window.location.href='goal_setting_to_achieving_crud.php?mode=delete&id='+id;
...
function CheckDispalyOrder(id)
{
	...
	function PrintReport(){
        ...
        var sales_executive = $("#sales_executive").val();
     	...
     	var myWindow = window.open('goal_setting_to_achieving_print.php?searchName='+searchName + "&sales_executive=" + sales_executive ,'','width=700,height=800');
     	myWindow.print();   
    }
...
function genReport()
	...
	//status = $("#status").val();
  	sales_executive = $("#sales_executive").val();
      	...
      	$.ajax({
			method: "POST",
			url: "goal_setting_to_achieving_genReport.php",
			data:{
