    ...
    <table class="heading" style="width:100%;" border="1">
       	<tr>
			...
			$pincode= stripslashes($customer_Detail_r['zip']); 
					...
					$state 	= stripslashes($db->rp_getValue("state","name","id=".$customer_Detail_r['state'].""));
					$country = stripslashes($db->rp_getValue("country","name","id=".$customer_Detail_r['country']."")); 
			...
			<strong>Name : </strong><?php echo stripslashes($customer_Detail_r['cname']); ?>
			<h2 class="heading">
					<strong>Phone</strong>: <?php echo stripslashes($customer_Detail_r['phone']); ?><br/>
					
					<strong>Email</strong>: <?php echo stripslashes($customer_Detail_r['email']); ?>
				</h2>
				<h2 class="heading" style="padding-top:0;"><strong> Address:</strong><?php echo stripslashes($customer_Detail_r['address'])."."; ?><br><?php echo str_replace(",,",",",$loc);?></h2>
				
			</td>
			<?php
			if($cart_detail_d['order_type']=='outlets')
			{
			$sales_id=$cart_detail_d['sales_id'];
			...
			else if($cart_detail_d['order_type']=='dealer')
			{
			$customer_id=$cart_detail_d['customer_id'];
			...
			else if($cart_detail_d['order_type']=='super_stockist')
			{
    ...
    <div id="content">
         ...
         <div id="invoice_body">
            ...
            <tr style="background:#eee;">
                <td style="text-align:center;width:48%;" colspan="2"><strong>Product Name</strong></td>
			...
			if(mysqli_num_rows($dispatch_item_r)>0){
				...
				while($dispatch_item_d = mysqli_fetch_array($dispatch_item_r)){
					...
					echo $totalprice = $db->rp_num($dispatch_item_d['amount']);
				...
				<tr>
					...
					<td style="text-align:center;width:20%;" align="right">
            ...
            <tr>
				<td style="text-align:center;width:48%;" colspan="3"><strong>Total</strong></td>
				...
				<td style="text-align:center;width:20%;" align="right"><?php echo CURR.$db->rp_num($total_pro_price); ?></td>
			...
			<table width="40%" align="right" style="width:40%" border="1">
				<tr>
				<td class="rp_right"><strong>Total Dispatch Qty</strong></td>
				<td class="rp_right"  align="right"><?php echo $total_pro_qty; ?></td>
				</tr>
				<!--tr>
				<td class="rp_right"><strong>Total Remaining Qty</strong></td>
				<td class="rp_right"  align="right"><?php// echo $total_remaining_qty; ?></td>
				</tr-->
				<tr>
