<?php
$page_id=669;
$page_slug='payment_followup_manage';
...
<body class="page-md">
    ...
    <div class="page-container">
        ...
        <div class="page-head bg-grey">
            <div class="container">
                <div class="page-title">
                    <h1><a href="payment_followup_manage.php" class="btn primary"><i class="fa fa-arrow-circle-o-left"></i>&nbsp;back</a> &nbsp;<?php echo $page_title; ?></h1>
                </div>
            </div>
        </div>
        ...
        <div class="page-content">
                            ...
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject bold font-green uppercase"> Manage
                                        ...
                                        } else if ($_REQUEST['mode'] == "customer_payment_followup") {
                                            $txt = "Customer Payment Followup";
                                        } else {
                                ...
                                <div class="actions">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons" style="margin-top: -6px">
                                        <a href="#createFollowup" style="padding: 7px" class="btn btn-success " target="#createFollowup" data-toggle="modal" title="Edit"><i class="fa fa-plus"></i>Create Payment Followup</a>
                                    </div>
                                </div>
            ...
            <?php
            if ($_REQUEST['mode'] == "customer_payment_followup") {
            ?>
            ...
            <div class="modal-content">
                <form role="form" action="" method="post" id="formLocation">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel1">Create Payment Followup</h4>
    ...
    <script type="text/javascript" src="js/customerpaymentfollowup.js"></script>
    ...
    <script type="text/javascript">
        ...
        function CreateFollowup() {
            ...
            if (followup_flag == "customer_payment_followup" || followup_flag == "customer_payment_followup") {
            ...
            if (description != "") {
                if (through != "" && through != 0) {
                    if (followup_date != "") {
                        $.ajax({
                            url: "payment_followup_ajax_function.php",
                            data: {
                                m: "save_followup",
        ...
        if (mode == "customer_payment_followup") {
            var sales_id = "<?php echo $_REQUEST['sales_id'] ?>";
            ...
            function del_conf(id, inquiry_id) {
                ...
                if (r) {
                    window.location.href = "payment_followuplist_crud.php?mode=payment_followup&sales_id=" + sales_id + '&id=' + id;
                }
            }
        }
