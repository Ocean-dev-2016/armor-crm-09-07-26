...
$fileName = "EXPENSE-FILE-".$cid;

if(!is_dir($fileName)){

	mkdir(EXPENSE_FILES.$fileName);

}

$pdf_file_path	= EXPENSE_FILES.$fileName."/".$fileName.'.pdf';
...
$xl_file_path	= EXPENSE_FILES.$fileName."/".$fileName.'.xls';
