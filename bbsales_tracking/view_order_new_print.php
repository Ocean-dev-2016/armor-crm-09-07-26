	...
	<table>
		...
		<table>
			<tbody>
				<tr class="text-center" style="background-color: <?= VIEW_COLOR ?>;">
					<th colspan="1" class="text-center" width="2%">SR No.</th>
		...
		<table>
			<tbody class="<?= $cl; ?>">
				...
				<tr>
					<td colspan="13" class="" rowspan="6" style="vertical-align: top;">
						<b>
							<?php
							if (isset($company_detail_d) && $company_detail_d != "" && $company_detail_d != 0) {
		...
		<table style="border: 3px solid #595959;border-collapse: collapse;">
			<tbody>
				<tr>
					<td style="padding:0;">
						<?php
