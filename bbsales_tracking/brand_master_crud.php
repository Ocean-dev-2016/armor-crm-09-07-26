<?php
$page_id=623;$page_slug='page_top_category';
$ctable 	= "brand";
$ctable2 	= "brand";
// $ctable1 	= "Top Category";
$ctable1 	= "Brand";
$main_page 	= "brand_manage";
...
require_once("../include/brand_master.class.php");
...
function check_form(){
	...
	if($("#name").val()=="" || $("#name").val().split(" ").join("")==""){		
		vd=aj.error('name',"Please Enter Brand Name.","add_error");
		isValid=false;
	}
	if(isValid)
	{
