<?php
$page_id=656;$page_slug='self_analysis_master';
include("connect.php");
...
if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!=""){
  $Where .= " (
              questions like '%".$_REQUEST['searchName']."%'         
            ) AND ";
}
  ...
  <thead>
    <tr>
      <th colspan="12" class="center">
        <h2>Self Analysis Master <?= date("d-m-Y h:i a");?> Printed By : <?=$_SESSION[SITE_SESS.'SESS_NAME'];?></h2>
      </th>
    </tr>
    <tr>
      <th>Sr No.</th>
 ...
 <tbody>
  ...
  ?>
    <tr>
      ...
      <td>
      <?php 
      echo stripslashes($ctable_d['questions']); 
      ?>
      </td>
