                                                                  ...
                                                                  ?>
                                                                        <tr>
                                                                           ...
                                                                           <td style="text-align:right;padding: 1px!important;">
                                                                              ...
                                                                              <span><input type='hidden' value="<?= $minimum_selling_price ?>" class='min-sell-price' /><strong>Min Sell Price: </strong> <?= $minimum_selling_price ?> </span>
                                                                           </td>
                                                                           <td style='text-align:right;padding: 1px!important;'>
                                                                              <?php
                                                                              if ($i['discount_per'] != 0) {
