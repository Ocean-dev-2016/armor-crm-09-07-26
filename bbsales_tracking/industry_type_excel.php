...
$file_name  = INDUSTRYTYPE_MASTER_EXPORT_EXCEL;
$Where = "";
...
$ctable1_r = $db->rp_getData("industry_type","id,name",$Where,"id DESC",0);
...
// $objPHPExcel->getActiveSheet()->setCellValue($column3.$rowCount, "Email");
