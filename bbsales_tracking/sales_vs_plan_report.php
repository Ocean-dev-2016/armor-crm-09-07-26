...
//     $.ajax({
//         type: "POST",
//         url: "sales_vs_plan_export.php", // ✅ correct file
//         data: {
...
//             if (result != "" && result != "0") {
//                 window.open(result, '_blank'); // ✅ open excel file
//             } else {
//                 alert("No data found");
//             }
//         },
...
function genReport() {
    ...
    var url = "sales_vs_plan_export.php?searchName=" + searchName +
              "&sales_executive=" + sales_executive +
              "&filter_month=" + filter_month +
              "&filter_year=" + filter_year;
    ...
    window.open(url, '_blank'); // ✅ direct download
            ...
            function genSalesPlanPrint() {
                ...
                // type = $("#type").val();
                var myWindow = window.open('sales_vs_plan_report_print.php?searchName=' + searchName + '&filter_month=' + filter_month + '&filter_year=' + filter_year + '&sales_executive=' + sales_executive, '', 'width=700,height=800');
                myWindow.print();
            }
