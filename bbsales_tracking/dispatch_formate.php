...
$type_of_company = $db->rp_getValue("orders","type_of_company","id='".$cart_detail_d['order_id']."' AND isDelete=0",0);

$company_detail_r = $db->rp_getData("company_master","*","id='".$type_of_company."' AND isDelete=0","",0);
...
<table>
	<tbody>
		...
		<tr>
			<td colspan="16" class="no-border-bottom no-border-top height-5 text-center">
				<strong>
					GST -
					<?php
						if (isset($company_detail_d) && $company_detail_d!="" && $company_detail_d!=0) 
		...
		<tr>
			...
			<td colspan="6" class="text-center no-border-right no-border-bottom" style="background-color: <?= VIEW_COLOR ?>"><b>Dispatch Order</b></td>
		...
		<tr class="vertical-top">
			...
			<td colspan="6" width="33%" class="no-border-bottom no-border-top border-r-width border-blue vertical-top">
			...
			<?php 
				...
				?>
			<td colspan="5" width="33%" class="no-border-bottom no-border-top vertical-top">
				<strong>Details<br/></strong>
					...
					<table class="no-border-top no-border-bottom no-border-right no-border-left" style="width: 100%!important;">
						...
						<tr>
							...
							<td class="no-border-right no-border-bottom no-border-left"><?= date('d-m-Y', strtotime($db->rp_getValue("orders","order_date","id = ".$cart_detail_d['order_id']))); ?></td>
						</tr>
						<!-- <tr>
