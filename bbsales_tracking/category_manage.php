...
var top_category_id="";
var searchName="";
var data_url = "category_get_ajax.php";
...
function genTopCategoryPrint() {
	...
	var myWindow = window.open('print_category_master_ajax.php?searchName='+searchName+'&top_category_id='+top_category_id,'','width=700,height=800');
 	myWindow.print();
 // 	setTimeout(function () 
	// {
	// 	myWindow.print();
...
function CheckDispalyOrder(id)
{
	...
	$.ajax({
		...
		data: 'display_order='+display_order+"&id="+size_id+"&table=category_master",
		success: function(result){
