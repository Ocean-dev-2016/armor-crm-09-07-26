<?php
$page_id=527;$page_slug='page_product';
$ctable 	= "product";
$ctable1 	= "Product";
$main_page 	= "product_mgmt";
$page 		= "manage_".$ctable;
$page_title = "Manage Order based Products Report";
								...
								<div class="row">
                                    <div class="col-md-4 col-xs-12 col-sm-12" style="margin-top:10px">
                                        <div class="form-group">
                                             <select class="form-control input-large status" name="category_id" id="category_id"  onChange="getSubCat(this.value);">
												<option value="">--- Select Category ---</option>
												 ...
												 <?php 
													...
													{
														?>
														<option value="<?php echo $category_list_r['id']?>">
...
var searchName="";
var category_id="";
var data_url = "<?php echo $ctable ?>_report_get_ajax.php";
...
function displayRecords(numRecords) {
	...
	$("#results" ).html("");
	$("#results" ).load( data_url+"?show=" + numRecords + "&searchName=" + searchName + "&category_id=" + category_id,function(){
		loadDataTable();
	...
	$("#results").on( "click", ".paging_simple_numbers a", function (e){
		...
		$("#results").load(data_url+"?show=" + numRecords + "&searchName=" + searchName + "&category_id=" + category_id,{"page":page}, function(){ //get content from PHP page
...
function genReportexcel(cid){
	...
	$.ajax({
		type: "POST",
		url: "product_report_genreport.php",
		data: '&rc='+rc,
		beforeSend: function() {
