...
//$page 		= "manage_".$ctable;
$page_title = $ctable1;
$page_hierarchy=array(array("link"=>"","title"=>"Master"),array("link"=>"self_analysis_que_manage.php","title"=>$page_title));
include("connect.php");
                           ...
                           <div class="col-md-7 col-xs-7 col-sm-7 pull-right">
                             <div class="form-inline" role="form">
                                    <form class="form-inline pull-right" role="form" onSubmit="return searchByName();">
                                          ...
                                          <input type="text" style="width: 450px!important" placeholder="Search By  Questions  :  " class="form-control input-large" name="searchName" id="searchName" value="" />
...
function genSalesExecutiveExcel(){
    	var searchName     = $("#searchName").val();
      	...
      	$.ajax({
	        method: "POST",
	        url: "self_analysis_master_excel.php",
	        data:{
 ...
 function genSalesExecutivePrint() {
    	...
    	var myWindow = window.open('print_self_analysis_master_ajax.php?searchName='+searchName ,'','width=700,height=800');
     	myWindow.print();
  //    	setTimeout(function () 
		// {
		// 	myWindow.print();
