...
// $d.=$string;
$url=ADMINSITEURL."inquiry_cancel_report_ajax.php?searchName=".$searchName."&type=".$type."&show=".$show."&state=".$state."&city=".$city."&df1=".$df1;
...
$fileName = "INQUIRY-CANCEL-REPORT-".date("d-m-Y");
