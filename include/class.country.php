...
class ClassType extends Functions
{
	...
	public function ClassTypeDelete($detail)
	{
		...
		"isDelete"	=> "1"
			...
			$where	= "id='".$detail['id']."'";
			$where_state_city	= "country_id='".$detail['id']."'";

			/*log entry*/
				$name = $this->db->rp_getValue("country","name","id='".$_REQUEST['id']."'");
				$module_name = "country";
				$flag = "Web";
			...
			if($uid!=0)
			{
				/*log entry*/
					...
					// $module_name1 = "state";
					// $flag = "Web";
					// $log_description1 = $module_name." Country name: ".$name." 's State Deleted By ".$_SESSION[SITE_SESS.'SESS_NAME']." ON ".date("Y-m-d H:i:s");	
				/*log entry*/
				//$uid=$this->db->rp_update("state",$rows,$where_state_city,0,$log_description1,$flag,$module_name1,"","");

				/*log entry*/
					// $name = $this->db->rp_getValue("country","name","id='".$_REQUEST['id']."'");
					// $module_name2 = "city";
					// $flag = "Web";
					// $log_description2 = $module_name." Country name: ".$name." 's city Deleted By ".$_SESSION[SITE_SESS.'SESS_NAME']." ON ".date("Y-m-d H:i:s");	
				/*log entry*/
				//$uid=$this->db->rp_update("city",$rows,$where_state_city,0,$log_description2,$flag,$module_name2,"","");
