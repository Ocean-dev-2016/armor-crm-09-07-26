...
{
	public $db;
	public $ctable="order_item_brand_master";
	...
	public function InsertDesignation($detail) 
	{
		...
		if($r){
			$reply=array("ack"=>0,"developer_msg"=>"Already Exist Designation Name","ack_msg"=>"Duplication! Already Exist Brand Name.");
			return $reply;
		}
		else
		{
			...
			if($uid!=0)
			{
				$reply=array("ack"=>1,"developer_msg"=>"Designation Added.","ack_msg"=>"Success! Brand Insert Successfully.");
				return $reply;
			}
			else
			{
	 ...
	 public function UpdateDesignation($detail)
	  {
			...
			if($r){
				...
				if($uid!=0)
				{
					$reply=array("ack"=>1,"developer_msg"=>"Designation Update Successfull!!.","ack_msg"=>"Success! Brand Update Successfully.");
					return $reply;
				}
				else
				{
