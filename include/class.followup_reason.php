...
class FollowupReason extends Functions
{
	public $db;
	public $ctable="followup_reason";
	...
	public function AddFollowupReason($detail) 
	{
		extract($detail);
	...
	public function UpdateFollowupReason($detail)
	{
		extract($detail);
	...
	public function GetFollowupReason($detail)
	{		
	...
	public function DeleteFollowupReason($detail)
	{
		$rows 	= array("isDelete" => "1");
		$where	= "id='".$_REQUEST['id']."'";
		/*log entry*/
			$name = $this->db->rp_getValue("followup_reason","name","id='".$_REQUEST['id']."'");
			$module_name = "Followup Reason";
			$flag = "Web";
